...
<%--            f.startDate.contentEditable = true;--%>
	...
	function addNewAgent()
    {
        ...
        else
        {
            ...
            openDialog("","agentSelection","top=10,left=10,resizable=yes,width=" + width + ",height=" + height,"ContractDetailTran","showAgentSelectionDialog");
        }
	}
...
<%
                    if (tempUIAgentHierarchyVOs != null)
                    {
                        for (int i = 0; i < tempUIAgentHierarchyVOs.length; i++)
                        {
                            ...
                            String segmentEffectiveDate = tempUIAgentHierarchyVOs[i].getSegmentEffectiveDate();
