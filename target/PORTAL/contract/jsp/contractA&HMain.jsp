<!--
 * Main contract screen for Accident & Health
 --> 
...
<%
    ...
    String editEffectiveDate = (String) request.getAttribute("editEffectiveDate");
...
<script language="Javascript1.2">
    ...
    var editEffectiveDate = "<%= editEffectiveDate %>";
	var dialog = null;
	var f = null;
    ...
    function init()
    {
	    ...
	    var e = document.getElementById("effectiveDateTitle");
		var n = document.getElementById("effectiveDateField")
		var r = document.getElementById("requiredField")
        if (editEffectiveDate == "true") {
	        document.getElementById("effectiveDateTitle").innerHTML = "Change Effective Date"; 
	        document.getElementById("requiredField").innerHTML = "* Required Field"; 
			document.getElementById("effectiveDateField").setAttribute("name", "changeEffectiveDate");
			document.getElementById("effectiveDateField").removeAttribute("disabled");
			//alert("Please set Change Effective Date.");
        } else {
//			e.innerHTML = "Effective Date"; 
//			document.getElementById("effectiveDateField").setAttribute("disabled","disabled");
        }
    ...
    {
        // No Riders for A&H so skip small save
        /*
    	if (disableContractFieldChanges == false) {
...
%>
	...
	<tr>
	  <td align="left" nowrap><span id="effectiveDateTitle">Effective Date:&nbsp;</span>
            <input id="effectiveDateField" disabled type="text" name="effectiveDate" value="<%= effectiveDate %>" size='10' maxlength="10">
            <span id="requiredField" style="color:red"></span>
      </td>
    ...
    <tr>
      <td align="left" nowrap>Face Amount:&nbsp;
        <input disabled type="text" name="faceAmount" maxlength="13" size="13" value="<%= faceAmount %>" CURRENCY>
      </td>
    ...
    <tr>
      <td align="left" nowrap>Units:&nbsp;
        <input disabled type="text" name="units" value="<%= units %>" maxlength="20">
      </td>
