...
<%
    ...
    String suspenseClientInformationTableName = "SuspenseClientInformation";
    ...
    if (startProcess.equals("true"))
    {
        ...
        try
        {
            ...
            DBTable suspenseClientInformationDBTable = DBTable.getDBTableForTable(suspenseClientInformationTableName);
            String suspenseClientInformationFullyQualifiedTableName = suspenseClientInformationDBTable.getFullyQualifiedTableName();

            String sql = "SELECT * FROM " + suspenseClientInformationFullyQualifiedTableName;
...
//            {
             ...
             if (dropDatabaseTable(out, conn, suspenseClientInformationTableName)) showSuccess(out, "Dropped SuspenseClientInformation Table");
...
<%!
    ...
    private boolean dropDatabaseTable(Writer out, Connection conn, String suspenseClientInformationTableName)  throws Exception
    {
        DBTable suspenseClientInformationDBTable = DBTable.getDBTableForTable(suspenseClientInformationTableName);
        String suspenseClientInformationFullyQualifiedTableName = suspenseClientInformationDBTable.getFullyQualifiedTableName();

        String removeSuspenseClientInformation = "DROP TABLE " + suspenseClientInformationFullyQualifiedTableName;
...
<%--                        <td><input type="text" name="driverClassName" value="net.sourceforge.jtds.jdbc.Driver" size="100"/></td>--%>
                        <td><input type="text" name="driverClassName" value="oracle.jdbc.driver.OracleDriver" size="100"/></td>
                    </tr>
                    <tr>
                        <td>JDBCUrl:</td>
<%--                        <td><input type="text" name="url" value="jdbc:jtds:sqlserver://SEG-DATABASE:1433/EDIT_SOLUTIONS_DEV" size="100" /></td>--%>
                    ...
                    <tr>
                        <td>SchemaName:</td>
                        <td><input type="text" name="schemaName" value="EDITSOLUTIONS_UNITTEST" size="100" /></td>
                    </tr>
                    <tr>
                        <td>Username:</td>
