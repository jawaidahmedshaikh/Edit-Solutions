...
<title>Bank Run Completed</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1>Bank Run Completed</h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="bankCompleteForm" method="post" action="/PORTAL/servlet/RequestManager">
