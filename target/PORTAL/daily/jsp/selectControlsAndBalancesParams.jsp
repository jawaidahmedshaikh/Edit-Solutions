...
<jsp:useBean id="cntlsAndBalsRptPageBean"
    class="fission.beans.PageBean" scope="request"/>

<%
	String[]  companyNames = cntlsAndBalsRptPageBean.getValues("companyNames");
%>
...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.cntrlsAndBalsRptForm;
	}

	function runControlsAndBalancesReport() {

        sendTransactionAction("DailyDetailTran", "runControlsAndBalancesReport", "main");

	}

	function closeSelectControlsAndBalancesParams() {
...
<form name="cntrlsAndBalsRptForm" method="post" action="/PORTAL/servlet/RequestManager">
  <table name="taxes" width="56%" border="0" cellspacing="0" cellpadding="0" height="110" bgcolor="#DDDDDD">
    ...
    <tr>
      ...
      <td width="65%" align="right" nowrap>
        <input type="button" name="enter" value=" Enter " onClick="runControlsAndBalancesReport()">
        <input type="button" name="cancel" value="Cancel" onClick="closeSelectControlsAndBalancesParams()">
      </td>
    </tr>
  </table>
