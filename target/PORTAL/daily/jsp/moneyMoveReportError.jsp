...
<script language="Javascript1.2">
	...
	function init()
    {
		f = document.moneyMoveReportErrorForm;
	}
...
<title>Money Move Report - Error</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1><%= reportMessage %></h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="moneyMoveReportErrorForm" method="post" action="/PORTAL/servlet/RequestManager">
