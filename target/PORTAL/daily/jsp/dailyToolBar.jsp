...
{
    var dialog = openDialog("batchStatDialog", "left=0,top=0,resizable=yes,scrollbars=yes", getScreenWidth() * 0.60, getScreenHeight() * 0.80);
...
<form name="batchToolBarForm" method="post" action="/PORTAL/servlet/RequestManager">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="2%">
    <tr>
      <td  align="center" bgcolor="#30548E"><font face="Arial, Helvetica, sans-serif"><b><i><font color="#FFFFFF" onMouseOver="showhideLayers('Layer1','','hide','Layer2','','hide')" size="2">EDIT<font size="1">SOLUTIONS
        - <font size="2">Daily</font></font></font></i></b></font></td>
    </tr>
  <tr bgcolor="#30548E">
    <td align="right">
