...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.activityFileCreationCompleteForm;
	}
...
<title>Controls And Balances Interface Complete</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1>Controls And Balances Interface Complete</h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="activityFileCreationCompleteForm" method="post" action="/PORTAL/servlet/RequestManager">
