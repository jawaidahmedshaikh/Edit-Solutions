...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.hedgeFundNotifyCompleteForm;
	}
...
<title>Hedge Fund Notification Complete</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1>Hedge Fund Notification Complete</h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="hedgeFundNotifyCompleteForm" method="post" action="/PORTAL/servlet/RequestManager">
