...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.noAcctngDetailToRunForm;
	}
...
<title>Accounting Detail Report Not Run</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1>No Accounting Detail For Selected Parameters</h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="noAcctngDetailToRunForm" method="post" action="/PORTAL/servlet/RequestManager">
