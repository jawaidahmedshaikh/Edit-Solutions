...
<script language="Javascript1.2">
	...
	function init()
    {
		f = document.caseManagerReviewErrorForm;
	}
...
<title>Case Manager Review - Error</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1><%= reportMessage %></h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="caseManagerReviewErrorForm" method="post" action="/PORTAL/servlet/RequestManager">
