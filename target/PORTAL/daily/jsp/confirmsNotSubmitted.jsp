...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.confirmsNotSubmittedForm;
	}
...
<title>Confirms Not Submitted</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1>Confirms Not Submitted - No Correspondence Pending Records Found</h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="confirmsNotSubmittedForm" method="post" action="/PORTAL/servlet/RequestManager">
