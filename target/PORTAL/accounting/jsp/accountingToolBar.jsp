...
function showCompanyStructureDialog() {

	openDialog("companyStructureDialog","resizable=no", 1, 1);
    sendTransactionAction("AccountingDetailTran", "showCompanyStructureDialog", "companyStructureDialog");
}
...
function runAccountingProcess()
{
	openDialog("accountRunDialog","resizable=no", 1, 1);
    sendTransactionAction("AccountingDetailTran", "showSelectAccountingToRun", "accountRunDialog");
}
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="3%">
    <tr>
      <td align="center" bgcolor="#30548E"><font face="Arial, Helvetica, sans-serif"><b><i><font color="#FFFFFF" size="2">EDIT<font size="1">SOLUTIONS
        - <font size="2">Accounting</font></font></font></i></b></font> </td>
    </tr>
  <tr bgcolor="#30548E">
    <td align="right">
    ...
    <tr bgcolor="#99BBBB">
      <td align="left">
        <img src="/PORTAL/common/images/btnCompany.gif" width="77" height="17" name="keyOff" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('keyOff','','/PORTAL/common/images/btnCompanyOver.gif',1)" onClick="showCompanyStructureDialog()">
      </td>
  </tr>
</table>
