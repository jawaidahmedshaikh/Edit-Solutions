<%@ page import="fission.utility.Util,
                 edit.common.*"%>
<%
    String message = Util.initString((String) request.getSession().getAttribute("LastRequestErrorMesssage"), "");
...
<html>
<head>
<meta http-equiv="REFRESH" content="10; URL=/PORTAL/common/jsp/portal.jsp">
...
<script language="JavaScript">
        ...
        if (top == self)                // i.e. If this is not part of a frameset
        {
            ...
            {
                opener.top.location = "/PORTAL/security/jsp/companyStructureNotSetError.jsp";
                window.close();         // close the dialog
            }
        }
        else                            // is a tab content
        {
            top.location = "/PORTAL/security/jsp/companyStructureNotSetError.jsp";
        }
  ...
  /*  function pauseThenExit()
    {
        if (top == self) // i.e. If this is not part of a frameset
        {
            ...
            {
                top.location = "/PORTAL/security/jsp/companyStructureNotSetError";
            }
        }
        else
        {
