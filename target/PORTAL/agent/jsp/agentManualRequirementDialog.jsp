...
<html>
<head>
<title>Agent Manual Requirement</title>
...
<script>
    ...
    function saveManualRequirement()
    {
        ...
        sendTransactionAction("AgentDetailTran", "saveManualRequirement", "contentIFrame");
    ...
    {
        sendTransactionAction("AgentDetailTran", "showRequirementDescription", "_self");
    }
