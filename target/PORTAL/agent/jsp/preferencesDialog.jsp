...
<%
    ...
    String selectedAgentNumber = (String) request.getAttribute("selectedAgentNumber");
...
function showContractAgentInformation()
{
    if (preferencePK != "")
    {
        ...
        sendTransactionAction("AgentDetailTran", "showContractAgentInfo", "contractAgentInfo");
    }
    else
    {
...
function savePreferenceInformation()
{
    ...
    {
        sendTransactionAction("AgentDetailTran", "savePreference", "_self");
    }
}

function addPreference()
{
    sendTransactionAction("AgentDetailTran", "clearPreferenceForAdd", "_self");
}

function selectPreferenceForAgent()
{
    sendTransactionAction("AgentDetailTran", "selectPreferenceForAgent", "contentIFrame");
    window.close();
}
...
function selectRow()
{
	...
	sendTransactionAction("AgentDetailTran", "showSelectedPreference", "_self");
}
...
<table id="table3" width="100%" border="0" cellspacing="6" cellpadding="0">
  <tr>
    <td align="right"colspan="4" nowrap>
      <input id="btnSelect" type="button" value=" Select " onClick="selectPreferenceForAgent()">
