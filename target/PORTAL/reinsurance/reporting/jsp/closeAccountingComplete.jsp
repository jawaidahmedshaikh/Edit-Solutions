...
<script language="Javascript1.2">
	...
	function init() 
    {
		f = document.closeAccountingCompleteForm;
	}
...
<title>Close Accounting Completed</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1>Accounting Close Completed</h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="closeAccountingCompleteForm" method="post" action="/PORTAL/servlet/RequestManager">
