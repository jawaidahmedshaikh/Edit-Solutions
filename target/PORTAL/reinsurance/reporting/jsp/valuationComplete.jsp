...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.valuationCompleteForm;
	}
...
<title>Valuation Completed</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1>Valuation Completed</h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="valuationCompleteForm" method="post" action="/PORTAL/servlet/RequestManager">
