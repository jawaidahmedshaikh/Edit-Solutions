...
<%
    ...
    String contractGroupFK = quoteMainSessionBean.getPageBean("formBean").getValue("contractGroupFK");
    String segmentDepartmentLocationFK = Util.initString(quoteMainSessionBean.getPageBean("formBean").getValue("departmentLocationFK"), "0");
    String priorContractGroupFK = quoteMainSessionBean.getPageBean("formBean").getValue("priorContractGroupFK");
    ...
    String conversionPeriodEndDate = Util.initString(quoteMainSessionBean.getPageBean("formBean").getValue("conversionDate"), "");
    ...
    if (premiumDue != null)
    {
        ...
        deductionAmount = premiumDue.getDeductionAmount().toString();
...
<html>
<head>
<title>EDIT SOLUTIONS - Quote Billing - List</title>
...
<script>
    ...
    function changeToIndividualBill()
    {
		...
		openDialog("changeToIndividualBillDialog","top=0,left=0,resizable=no", width, height);

        sendTransactionAction("QuoteDetailTran", "changeToIndividualBill", "changeToIndividualBillDialog");
    }
...
<%--    BEGIN Form Content --%>
  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td align="left" valign="top" colspan="5">
            ...
            <span style="width:7%; position:relative; top:0; left:0; z-index:0; overflow:visible">
              <table width="100%" height="100%">
                <tr>
                    <td align="left" nowrap rowspan="9">&nbsp;</td>
                </tr>
              </table>
            </span>
            ...
            <span style="position:relative; top:0; left:0; z-index:0; overflow:visible">
              <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                    <td align="left" nowrap>Department/Location:&nbsp;</td>
                    <td align="left" nowrap="nowrap">
    ...
    <!-- The Change To Individual Bill button has been commented out temporarily.  The full functionality will
    ...
    <!--
	  	<td nowrap align="left" colspan="2">
			<input id="btnChangeToIndividualBill" type="button" value="Change To Individual Bill" onClick="changeToIndividualBill()">
	  	</td>
    -->
        <td nowrap align="left" >
			<input id="btnChangeToListBill" type="button" value="Change Group Bill" onClick="changeToListBill()">
	  	</td>
