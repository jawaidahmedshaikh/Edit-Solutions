...
function init() {
	...
	f = document.requirementToolBarForm;
}
...
<form name="requirementToolBarForm" method="post" action="/PORTAL/servlet/RequestManager">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="3%">
    <tr>
      <td align="center" bgcolor="#30548E"><font face="Arial, Helvetica, sans-serif"><b><i><font color="#FFFFFF" size="2">EDIT<font size="1">SOLUTIONS
        - <font size="2">Requirement Table</font></font></font></i></b></font> </td>
    </tr>
  <tr bgcolor="#30548E">
    <td align="right">
