...
function init() {
	...
	f = document.roleToolBar;

    updateLockState(<%= userSession.getClientRoleIsLocked() %>, "<%= userSession.getUsername() %>", "<%= userSession.getClientRolePK() %>");
}
...
function showCancelClientConfirmationDialog() {
    ...
    openDialog("cancelRoleDialog","resizable=yes", width, height);
    sendTransactionAction("RoleTran", "showCancelRoleConfirmationDialog", "cancelRoleDialog");
}
...
function lockClient(){
	...
	contentIFrame.sendTransactionAction("RoleTran", "lockRoles", "contentIFrame");
}
...
function saveRoles()  {
	...
	contentIFrame.sendTransactionAction("RoleTran", "saveRoles", "contentIFrame");
}
...
<form name="roleToolBar" method="post" action="/PORTAL/servlet/RequestManager">
  <table width="100%" border="0" cellspacing="0" cellpadding="3">
      ...
      <td colspan="4" align="center" bgcolor="#30548E">
        <b><i>
            <font face="Arial, Helvetica, sans-serif">
               <font color="#FFFFFF" size="2">EDIT<font size="1">SOLUTIONS- </FONT>Roles</font>
           </FONT>
        </i></b>
        </td>
    ...
    <tr bgcolor="#99BBBB">
      <td valign="bottom" colspan="5" nowrap width="50%">
        ...
        <img src="../../common/images/btnSave.gif" id="btnSave" width="77" height="17" name="save" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('save','','../../common/images/btnSaveOver.gif',1)" onClick="saveRoles()">
