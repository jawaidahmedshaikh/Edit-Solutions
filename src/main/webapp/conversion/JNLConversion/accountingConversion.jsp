...
<%
    ...
    if (startProcess.equals("true"))
    {
        ...
        try
        {
            ...
            ConvertAccounting convertAccounting = new ConvertAccounting(conn, crud);


            convertAccounting.convertElementTable(countTable);
            showSuccess(out, "Number of Element records in = " + countTable.get("ELcountIn") + " out = " + countTable.get("ELcountOut"));
            showSuccess(out, "Number of ElementStructure records in = " + countTable.get("EScountIn") + " out = " + countTable.get("EScountOut"));
            showSuccess(out, "Number of ElementCompanyRelation records in = " + countTable.get("ECRcountIn") + " out = " + countTable.get("ECRcountOut"));
            showSuccess(out, "Number of Account records in = " + countTable.get("ACcountIn") + " out = " + countTable.get("ACcountOut"));

            convertAccounting.convertAccountingDetailTable(countTable);
            showSuccess(out, "Number of AcountingDetail records in = " + countTable.get("ADcountIN") + " out = " + countTable.get("ADcountOut"));
...
<html>
    ...
    <body>
        ...
        <h1>Convert ACCOUNTING Database to the matching tables in EDITSolutions </h1>

        <p>
        This process will:
        <br>
        <br>1. Read each row of the Prior Version of a defined ACCOUNTING table.
        ...
        has been loaded with the CodeTableDef and CodeTable data.  This job will populate the following tables: Account, ElementStructure,
        ElementCompanyRelation and AccountingDetail from the ACCOUNTING database.
        <br>
        <br>Please change the connection information below in order to attach the ACCOUNTING table to this process.
        ...
        <form name="theForm">
            ...
            <table border="0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>JDBCUrl:</td>
<%--                        <td><input type="text" name="url" value="jdbc:jtds:sqlserver://SEG-DATABASE:1433/ACCOUNTING_RX" size="100" /></td>--%>
                         <td><input type="text" name="url" value="jdbc:jtds:sqlserver://localhost:1433;DatabaseName=ACCOUNTING" size="100" /></td>
                    </tr>
                    <tr>
                        <td>SchemaName:</td>
