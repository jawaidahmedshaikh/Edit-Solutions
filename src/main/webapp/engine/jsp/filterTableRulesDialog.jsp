...
<%
    ...
    String filterType = Util.initString((String) request.getAttribute("tableFilterType"), "All");
    String filterName = (String) request.getAttribute("tableFilterName");
...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.tableRulesFilterForm;
	}
    ...
    function checkForFilterName()
    {
        ...
        {
            sendTransactionAction("ProductRuleStructureTran", "populateFilterNames", "filterTableRulesDialog");
        }
    }
	...
	function filterTableRules()
    {
        ...
        {
            sendTransactionAction("ProductRuleStructureTran", "filterTableRules", "buildRuleDialog");
            window.close();
        }
	}
...
<title>Table Rules Filter</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<body bgcolor="#DDDDDD" onLoad="init()" bgcolor="#DDDDDD">
<form name="tableRulesFilterForm" method="post" action="/PORTAL/servlet/RequestManager">
  <table id="table1" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#DDDDDD">
    ...
    <tr>
      <td width="57%" align="right" nowrap colspan="5">
        <input type="button" name="enter" value="Enter" onClick="filterTableRules()">
      </td>
    </tr>
  </table>
  ...
  <input type="hidden" name="filterPage" value="Table">
