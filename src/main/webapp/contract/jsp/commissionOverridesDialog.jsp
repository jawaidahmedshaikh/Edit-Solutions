...
<script language="Javascript1.2">
	...
	function saveCommissionOverrides()
    {
        ...
        sendTransactionAction("ContractDetailTran", "saveCommissionOverrides", "contentIFrame");
        closeWindow();
	}

    /**
     * Sets servicingAgentIndicator to "N" or null
     */
    function deleteCommissionOverrides()
    {
        sendTransactionAction("ContractDetailTran", "deleteCommissionOverrides", "contentIFrame");
