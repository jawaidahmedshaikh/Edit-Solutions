...
<%
    ...
    String companyStructureId = Util.initString(contractMainSessionBean.getPageBean("formBean").getValue("companyStructureId"), "0");
...
<%--		window.resizeTo(getPreferredWidth(), getPreferredHeight());--%>
	...
	function save()
    {
	    sendTransactionAction("ContractDetailTran", "addLifeRider", "contentIFrame");
