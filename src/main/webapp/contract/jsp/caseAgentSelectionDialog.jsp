...
<script language="Javascript1.2">
    ...
    function doAgentSearch()
    {
        ...
        {
            sendTransactionAction("SearchTran", "findAgentForCaseByName", "_self");
        }
        else
        {
    ...
    function showAgentHierarchy(agentNumber)
    {
        ...
        sendTransactionAction("CaseDetailTran", "showReportToAgent", "_self");
    }
    ...
    function saveAgentSelection(){
        ...
        else
        {
          <%
            ...
            {
                sendTransactionAction("CaseDetailTran","saveAgentSelection","main");
                window.close();
            }
        }
    }
    ...
    {
        sendTransactionAction("CaseDetailTran","closeAgentSelectionDialog","_main");
        window.close();
    }
  ...
  <table width="100%" height="2%">
    <tr>
      <td align="right">
        ...
        <input type="button" value="Cancel" onClick="cancelAgentSelection()">
      </td>
    </tr>
  </table>
