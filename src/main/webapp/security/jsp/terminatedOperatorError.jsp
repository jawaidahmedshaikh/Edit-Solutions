...
<script language="JavaScript">
        ...
        if (top == self)                // i.e. If this is not part of a frameset
        {
            ...
            {
                opener.top.location = "/PORTAL/security/jsp/terminatedOperator.jsp";
                window.close();         // close the dialog
            }
        }
        else                            // is a tab content
        {
            top.location = "/PORTAL/security/jsp/terminatedOperatorError.jsp";
        }
  ...
  /*  function pauseThenExit()
    {
        if (top == self) // i.e. If this is not part of a frameset
        {
            ...
            {
                top.location = "/PORTAL/security/jsp/terminatedOperator";
            }
        }
        else
        {
