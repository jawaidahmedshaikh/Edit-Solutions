...
<script>
    ...
    {
        sendTransactionAction("AgentBonusTran", "showBonusProgram", window.opener.name);
    ...
    function addContributingCommissionProfiles()
    {
        ...
        else
        {
            ...
            sendTransactionAction("AgentBonusTran", "addContributingCommissionProfiles", "commProfileSelectionDialog");
        }
    }
    ...
    function removeContributingCommissionProfiles()
    {
        ...
        else
        {
            ...
            sendTransactionAction("AgentBonusTran", "removeContributingCommissionProfiles", "commProfileSelectionDialog");
        }
    }
</script>
<%-- ****************************** END JavaScript ****************************** --%>
...
<%
    if (commissionProfileVOs != null) // Test for the existence of the target VOs.
    {
        ...
        Long currentBonusProgramPK = new Long(bonusProgramPK);
        ...
        for (int i = 0; i < commissionProfileVOs.length; i++) // Loop through the target VOs.
        {
            ...
            Long currentCommissionProfilePK = new Long(currentCommissionProfileVO.getCommissionProfilePK());

            ContributingProfile contributingProfile = ContributingProfile.findBy_CommissionProfilePK_BonusProgramPK(currentCommissionProfilePK, currentBonusProgramPK);
...
<input:hidden name="bonusProgramPK" default="<%= bonusProgramPK.toString() %>"/>
