  ...
  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#DDDDDD">
    <tr>
      ...
      <td align="left" nowrap>
        <input disabled type="text" name="adaAmount" maxlength="11" size="11" value="<%= adaAmount %>" CURRENCY>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" nowrap>
        <input disabled type="text" name="expenseAllowance" maxlength="11" size="11" value="<%= expenseAllowance %>" CURRENCY>
      </td>
    </tr>
    <tr>
...
<%--      <td align="left" nowrap>--%>
<%--        <input disabled type="text" name="bonusAmount" maxlength="11" size="11" value="<%= bonusAmount %>" CURRENCY>--%>
<%--      </td>--%>
<%--    </tr>--%>
    <tr>
