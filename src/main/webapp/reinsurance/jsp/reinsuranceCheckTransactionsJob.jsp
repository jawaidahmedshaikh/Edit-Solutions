...
<html>
<head>
<title>Create Reinsurance Checks</title>
...
<script>
     ...
     */
    function createReinsuranceCheckTransactions()
    {
        sendTransactionAction("ReinsuranceTran", "createReinsuranceCheckTransactions", "main");
    }
...
<%--        </td>--%>
        <td align="right" nowrap width="50%">
            Run Reinsurance Checks Or Cancel: &nbsp;<input type="button" value="Enter" onClick="createReinsuranceCheckTransactions()">
        </td>
