...
<script>
     ...
     */
    function updateAgentBonuses()
    {
        sendTransactionAction("ReportingDetailTran", "updateAgentBonuses", "main");
    }
...
<%--    BEGIN Form Content --%>
    <tr>
        <td align="right" nowrap width="50%">
            Run Agent Bonus Update Or Cancel: &nbsp;<input type="button" value="Enter" onClick="updateAgentBonuses()">
        </td>
