...
<!-- ***** JAVASCRIPT ***** quote.jsp.contractClientAdd.jsp -->
<script>
 ...
 */        
 		...
 		gCity = currentRow.cells[4].innerHTML;
		gState = currentRow.cells[5].innerHTML;
		gAddressLine1 = currentRow.cells[6].getElementsByTagName('input')[0].value;
		gZipCode = currentRow.cells[7].getElementsByTagName('input')[0].value;
    ...
    function doClientSearch() {
        ...
        if (f.clientName.value.length > 0 && f.dob.value.length > 0) {
            sendTransactionAction("QuoteDetailTran", "findClientsByNameDOB", "_self");
        } else if (f.clientName.value.length > 0 && f.dob.value.length == 0) {
            f.searchType.value = nameSearch;
            sendTransactionAction("QuoteDetailTran", "findClients", "_self");
    ...
    function buildContractClientRoles() {
        ...
        if (f.selectedClientDetailPK.value == "") {
            ...
            <%--		    f.selectedOptionId.value = f.optionId;--%>

            sendTransactionAction("QuoteDetailTran", "buildRolesAndContractClients", "contentIFrame");
...
<span id="span1"
  ...
  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="4">
    ...
    <tr>
      ...
      <td align="right" nowrap>
        <input type="button" value="Search" onClick="doClientSearch()">
      </td>
    </tr>
  </table>
</span>
  ...
  <table class="summaryArea" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr height="10">
      ...
      <th align="left" width="16%">Tax Id</th>
      <th align="left" width="16%">Client Status</th>
      <th align="left" width="16%">Date Of Birth</th>
      <th align="left" width="16%">City</th>
    ...
    <span id="span3" style="position:relative; width:100%; height:25%; top:0; left:0; z-index:0">
    ...
    <tr>
      <td nowrap width="100%" height="100%">
        ...
        <table class="contentArea" id="roleTable" width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          %>
          <tr class="<%= className2 %>" roleId="<%= codeTablePK %>" onMouseOver="highlightRoleRow()"
      ...
      <table class="summaryArea" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr height="10">
          ...
          <th align="left">Amount</th>
            ...
            %>
                    <tr class="<%= className %>" id="<%= currentRiderNumber %>" riderNumber="<%= currentRiderNumber %>"
