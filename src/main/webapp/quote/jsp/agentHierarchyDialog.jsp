        ...
        for (int h = 0; h < uiAgentHierarchyVOs.length; h++) {
            ...
            for (int s = 0; s < agentSnapshotVOs.length; s++) {
                ...
                if (agentSnapshotPK.equals(selectedAgentSnapshotPK)) {
                    ...
                    ClientRoleVO clientRoleVO = (ClientRoleVO) placedAgentVO.getParentVO(ClientRoleVO.class);
...
<%!
    private String getClientDetailName(ClientDetailVO clientDetailVO)
    {
        ...
        {
            name = clientDetailVO.getLastName() + ", " + clientDetailVO.getFirstName() + clientDetailVO.getMiddleName();
        }
...
<script language="Javascript1.2">
    ...
    function selectHierarchyRow() {
        ...
        sendTransactionAction("QuoteDetailTran", "showSelectedHierarchyRow", "_self");
    }
    ...
    function selectProfileRow() {
        ...
        sendTransactionAction("QuoteDetailTran", "selectCommProfileForAgent", "_self");
    }
    ...
    function saveHierarchy() {
        ...
        sendTransactionAction("QuoteDetailTran","saveAgentHierarchy","_self");
    }

    function closeHierarchyDialog(){

        sendTransactionAction("QuoteDetailTran","closeAgentHierarchy","contentIFrame");
        window.close();
    }
