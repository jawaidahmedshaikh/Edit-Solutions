...
function showContractAgentInformation()
{
    if (preferencePK != "")
    {
        ...
        sendTransactionAction("QuoteDetailTran", "showContractAgentInfo", "contractAgentInfo");
    }
    else
    {
...
function savePreferenceInformation()
{
    if (shouldShowLockAlert == true)
    {
        alert("The Agent Cannot Be Edited.");
    ...
    } else if (f.overrideStatus.value == "")
    {
        ...
        sendTransactionAction("QuoteDetailTran", "savePreference", "_self");
    }
}

function selectPreferenceForClient()
{
    sendTransactionAction("QuoteDetailTran", "selectPreferenceForClient", "contentIFrame");
    window.close();
}

function addPreference()
{
    sendTransactionAction("QuoteDetailTran", "clearPreferenceForAdd", "_self");
}
...
function selectRow()
{
	...
	sendTransactionAction("QuoteDetailTran", "showSelectedPreference", "_self");
}
