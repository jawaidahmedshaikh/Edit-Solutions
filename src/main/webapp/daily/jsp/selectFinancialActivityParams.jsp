...
<jsp:useBean id="finActivityRptPageBean"
    class="fission.beans.PageBean" scope="request"/>

<%
	String[]  companyNames = finActivityRptPageBean.getValues("companyNames");
%>
...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.finActivityRptForm;
	}

	function runFinancialActivityReport() {

        sendTransactionAction("DailyDetailTran", "runFinancialActivityReport", "main");
	}

	function closeSelectFinActivityParams() {
...
<form name="finActivityRptForm" method="post" action="/PORTAL/servlet/RequestManager">
  <table name="taxes" width="56%" border="0" cellspacing="0" cellpadding="0" height="110" bgcolor="#DDDDDD">
    ...
    <tr>
      ...
      <td width="65%" align="right" nowrap>
        <input type="button" name="enter" value=" Enter " onClick="runFinancialActivityReport()">
        <input type="button" name="cancel" value="Cancel" onClick="closeSelectFinActivityParams()">
      </td>
    </tr>
  </table>
