...
<jsp:useBean id="checkNumberImportPageBean"
    class="fission.beans.PageBean" scope="request"/>
<%
	String[]  companyNames = checkNumberImportPageBean.getValues("companyNames");
%>

<html>
<head>

<title>EDITSolutions - Check Number Import</title>
...
<script language="Javascript1.2">
	...
	function processAccounting()
    {
		...
		sendTransactionAction("DailyDetailTran", "runCheckNumberImport", "main");
	}
