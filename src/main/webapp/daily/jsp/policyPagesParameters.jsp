...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.policyPagesParametersForm;

	}

	function runPolicyPages()
    {
		sendTransactionAction("DailyDetailTran", "runPolicyPages", "main");
...
<form name="policyPagesParametersForm" method="post" action="/PORTAL/servlet/RequestManager">
  <table name="batch" width="56%" border="0" cellspacing="0" cellpadding="0" bgcolor="#DDDDDD">
    ...
    <tr>
      <td colspan="3" align="right">
        <input type="button" name="enter" value=" Enter " onClick="runPolicyPages()">
