...
<%
    String returnMessage = (String) request.getAttribute("returnString");
%>
<html>
<head>
...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.uvImportCompleteForm;
	}
...
<title>UV Import Completion</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1><%= returnMessage %></h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="uvImportCompleteForm" method="post" action="/PORTAL/servlet/RequestManager">
