...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.accountingCompleteForm;
	}
...
<title>Accounting Completed</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1>Accounting Completed</h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="accountingCompleteForm" method="post" action="/PORTAL/servlet/RequestManager">
