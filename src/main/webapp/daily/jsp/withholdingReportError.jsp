...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.withholdingReportErrorForm;
	}
...
<title>Withholding Report Not Run</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1>Withholding Report Not Run - No Activity Was Found For the Selected Dates</h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="withholdingReportErrorForm" method="post" action="/PORTAL/servlet/RequestManager">
