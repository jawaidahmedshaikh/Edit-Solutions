...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.withholdingReportCompleteForm;
	}
...
<title>Withholding Report Completed</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1>Withholding Report Completed</h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="withholdingReportCompleteForm" method="post" action="/PORTAL/servlet/RequestManager">
