...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.uvUpdateCompleteForm;
	}
...
<title>UV Update Complete</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1>Unit Value Update Complete</h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="uvUpdateCompleteForm" method="post" action="/PORTAL/servlet/RequestManager">
