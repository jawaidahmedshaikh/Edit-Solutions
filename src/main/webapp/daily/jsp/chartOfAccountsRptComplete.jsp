...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.chartOfAccountsRptCompleteForm;
	}
...
<title>Chart Of Accounts Report Generated</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1>Chart Of Accounts Report Generated</h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="chartOfAccountsRptCompleteForm" method="post" action="/PORTAL/servlet/RequestManager">
