...
<script language="Javascript1.2">
	...
	function init() {
		...
		f = document.cashClearanceUpdateForm;
	}
...
<title>Cash Clearance Import Result</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<body bgcolor="#FFFFFF" onLoad="init()">
<center><b><%= responseMessage %></b></center>
<form name="cashClearanceUpdateForm" method="post" action="/PORTAL/servlet/RequestManager">
