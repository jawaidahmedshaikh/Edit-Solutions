 ...
 * subject to the license agreement.
 -->
 <%
     String test = "GroupComponent.saveBatchProgressLog";
     ...
     String requestXMLString =  "<SEGRequestVO>\n" +
                                ...
                                "       <DaysAdded>3</DaysAdded>\n" +
                                "       <DaysAddedReasonCT>Excuse</DaysAddedReasonCT>\n" +
     ...
     // Call service
     Document responseDocument = group.saveBatchProgressLog(requestDocument);
 %>
