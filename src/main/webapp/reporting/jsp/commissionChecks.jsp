...
<script language="Javascript1.2">
	...
	function runCommissionChecks() {
        ...
        try
        {
            ...
            {
               sendTransactionAction("ReportingDetailTran", "createCommissionCheckCK", "main");
            }
        }
        catch (e)
        {
  ...
  <table id="table1" name="reporting" width="56%" border="0" cellspacing="0" cellpadding="0" height="110" bgcolor="#DDDDDD">
    ...
    <tr>
      ...
      <td width="98%" align="right" nowrap>
        <input type="button" name="enter" value=" Enter " onClick="runCommissionChecks()">
