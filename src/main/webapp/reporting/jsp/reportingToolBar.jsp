...
function init() {
	...
	f = document.reportingToolBarForm;
}

/**
 * Opens the Batchstat dialog.
 */
function showBatchStat()
{
    var dialog = openDialog("batchStatDialog", "left=0,top=0,resizable=no,scrollbars=yes", getScreenWidth() * 1.0, getScreenHeight() * 0.90);

    dialog.location.href = "/PORTAL/batch/jsp/batchStats.jsp";
}
...
<!-- ****** HTML CODE ***** //-->
<body bgColor="#99BBBB"  onLoad="init()" onLoad="MM_preloadImages('../images/ButtonAdd_on.gif','../images/ButtonSave_on.gif','../images/ButtonDelete_on.gif','../images/ButtonCancel_on.gif','../images/ButtonSearch_on.gif','../images/Button-Filter_on.gif','../images/ButtonCustomize_on.gif')">
...
<form name="reportingToolBarForm" method="post" action="/PORTAL/servlet/RequestManager">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="3%">
    <tr>
      <td align="center" bgcolor="#30548E"><font face="Arial, Helvetica, sans-serif"><b><i><font color="#FFFFFF" size="2">EDIT<font size="1">SOLUTIONS
        - <font size="2">Reporting</font></font></font></i></b></font> </td>
  </tr>
  <tr bgcolor="#30548E">
    <td align="right">
    ...
    <tr bgcolor="#99BBBB">
        <td align="right">
            <a href="javascript:showBatchStat()"><img src="/PORTAL/batch/images/batchStats.gif" border="0"></img></a>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </td>
    </tr>
