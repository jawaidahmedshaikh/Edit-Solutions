...
<script language="Javascript1.2">
	...
	function init() 
    {
		f = document.accountingExtractCompleteForm;
	}
...
<title>Accounting Extract Completed</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<h1>Accounting Extract Completed</h1>
<body bgcolor="#FFFFFF" onLoad="init()">
<form name="accountingExtractCompleteForm" method="post" action="/PORTAL/servlet/RequestManager">
