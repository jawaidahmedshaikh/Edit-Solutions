...
<%
    if (logEntryCollectionVO != null) // Test for the existence of the target VOs.
    {
        ...
        for (int i = 0; i < logEntryVOs.length; i++) // Loop through the target VOs.
        {
            ...
            String lastName = getContextValue(currentLogContextEntryVOs, "LastName");

            String corpName = getContextValue(currentLogContextEntryVOs, "CorpName");

            String agtNumber = getContextValue(currentLogContextEntryVOs, "AgentNumber");
...
%>
        <tr class="<%= className %>">
            <td nowrap width="12%" style="border-bottom:1px solid #A9A9A9">
                <%= operator %>
            </td>
            <td nowrap width="12%" style="border-bottom:1px solid #A9A9A9">
                <%= lastName %>
