package com.segsoftware.view.custom
{
	...
	public class AccordionIcons extends Accordion
	{
	 	 ...
	 	 * @default upIcon.gif
	 	 */	
	 	[Embed(source="/com/segsoftware/view/assets/icons/upIcon.gif")] 
        [Bindable]
        ...
        /**
	 	 ...
	 	 */	
	 	[Embed(source="/com/segsoftware/view/assets/icons/downIcon.gif")] 
        [Bindable]
        ...
        /**
	 	 ...
	 	 */	
	 	[Embed(source="/com/segsoftware/view/assets/icons/selectedIcon.gif")] 
        [Bindable]
         ...
         * @private 
         * 
		 * Assigns each pane with either the upIcon, downIcon, or selectedIcon
		 */
