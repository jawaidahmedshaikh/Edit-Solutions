 ...
 * @author sprasad
 */
public class TerminatedCaseCountGenerator extends ConversionAudit
{
    private static String FILE_NAME = "TerminatedCaseCount";

    private static String FILE_EXTENSION = ".txt";

    private static final String FILE_HEADER = "BusinessName " + DEMARCATOR + "TerminatedCaseCount";

    private File file = null;

    public TerminatedCaseCountGenerator()
    {
    ...
    public void generate() throws Exception
    {
        ...
        try
        {
            ...
            for (int i = 0; i < results.size(); i++)
            {
                ...
                Long terminatedCaseCount = (Long) columnValues[1];

                String aLine = businessContractName + DEMARCATOR + terminatedCaseCount;
