 ...
 * ignored.
 */
public interface InduaseAdapter extends ICRUD
{
    /**
     ...
     * is in the InduaseContractClient (unless the Segment's PolicyGroup is of type Case, then Billing would already be in
    ...
    /**
     * Saves a segment to the database and associates it with the given PolicyGroup.  If no caseNumber is provided,
     * it is assumed to be an individual policy (i.e. an Individual PolicyGroup is automatically created).
     * <P>
     ...
     * @param companyStructureAsXML             XML representation of CompanyStructureVO
