...
public class RegressionTestPopulatingClient
{
    ...
    public static void main(String[] args) throws Exception, Throwable
    {
        ...
        RegressionTestPopulatingClient soapClient = new RegressionTestPopulatingClient();
...
//        {
    ...
    private void processSPDATransactions(IProxy proxy, SegmentVO segmentVO, int numberOfContracts) throws Throwable
     {
         //Now setup and process the initial premium trx
         String contractNumber = segmentVO.getContractNumber();
//         processInitialPremium(proxy, contractNumber, numberOfContracts, segmentVO.getEffectiveDate());
...
//         }
         ...
         {
             String policyAmount = "5000";
             String editTrxPK = (String)proxy.invoke("addSurrenderTrx", new Object[] {contractNumber, policyAmount, "2005/02/01"});
         }
         else if (contractNumber.startsWith("STRAN"))
         {
             String policyAmount = "5000";
             String editTrxPK = (String)proxy.invoke("addTransferTrx", new Object[] {contractNumber, policyAmount, "2005/02/01"});
         }
         else if (contractNumber.startsWith("SWD"))
         {
             String policyAmount = "5000";
             String editTrxPK = (String)proxy.invoke("addWithdrawalTrx", new Object[] {contractNumber, policyAmount, "2005/02/01"});
         }
         else if (contractNumber.startsWith("SDTH"))
         {
             String policyAmount = "5000";
             String editTrxPK = (String)proxy.invoke("addDeathTrx", new Object[] {contractNumber, policyAmount, "2005/02/01"});
         }
...
//                    clientId1, birthDate1, genderCT1, roleTypeCTs, companyStructureVO);
        ...
        createContracts(proxy, contractNumberRoot2, numberOfContracts2, effectiveDate2, clientFirstName2, clientLastNameRoot2,
                    clientId2, birthDate2, genderCT2, roleTypeCTs, companyStructureVO, startingContractNumber);
    }
...
//        String effectiveDate6 = "2004/02/01";
        ...
        //  1st set
        createContracts(proxy, contractNumberRoot1, numberOfContracts1, effectiveDate1, clientFirstName1, clientLastNameRoot1,
                    clientId1, birthDate1, genderCT1, roleTypeCTs, companyStructureVO, startingContractNumber);
...
//                    clientId2, birthDate2, genderCT2, roleTypeCTs, companyStructureVO);
        ...
        createContracts(proxy, contractNumberRoot3, numberOfContracts3, effectiveDate3, clientFirstName3, clientLastNameRoot3,
                    clientId3, birthDate3, genderCT3, roleTypeCTs, companyStructureVO, startingContractNumber);

        // 4th set
        createContracts(proxy, contractNumberRoot4, numberOfContracts4, effectiveDate4, clientFirstName4, clientLastNameRoot4,
                    clientId4, birthDate4, genderCT4, roleTypeCTs, companyStructureVO, startingContractNumber);

        // 5th set
        createContracts(proxy, contractNumberRoot5, numberOfContracts5, effectiveDate5, clientFirstName5, clientLastNameRoot5,
                    clientId5, birthDate5, genderCT5, roleTypeCTs, companyStructureVO, startingContractNumber);

         // 6th set
        createContracts(proxy, contractNumberRoot6, numberOfContracts6, effectiveDate6, clientFirstName6, clientLastNameRoot6,
                    clientId6, birthDate6, genderCT6, roleTypeCTs, companyStructureVO, startingContractNumber);
    }

    private void populateSPDA(IProxy proxy)  throws Throwable
    {
        String companyName = "SEG";
        String marketingPackageName = "*";
        String groupProductName = "*";
...
//                    clientId2, birthDate2, genderCT2, roleTypeCTs, companyStructureVO);
    ...
    private void createContracts(IProxy proxy, String contractNumberRoot, int numberOfContracts, String effectiveDate,
                                ...
                                String genderCT, ArrayList roleTypeCTs, ProductStructureVO companyStructureVO, int startingContractNumber) throws Throwable
    {
        for (int i = startingContractNumber; i < numberOfContracts; i++)
        {
            ...
            {
                segmentVO = addPolicySPDA(proxy, contractNumber, effectiveDate, companyStructureVO, clientRolePKs);
                processSPDATransactions(proxy, segmentVO, numberOfContracts);
            }
...
//        String masterNumber = contractNumber;
    ...
    private SegmentVO addPolicySPDA(IProxy proxy, String contractNumber, String effectiveDate, ProductStructureVO companyStructureVO, ArrayList clientRolePKs)  throws Throwable
    {
//        String masterNumber = contractNumber;
        String caseNumber = " ";
