...
import extension.business.*;
import extension.component.*;



/**
 * This client is used to populate a database.  It uses the PerformanceTuningAdapter to do the work.  The adapter
 * requires objects via XML strings because it was built for SOAP use.  We are not using SOAP here, just calling the
 * adapter directly.
 */
public class IBMPopulatingClient
{
    final static boolean debug = false;    // for debug writes to screen

    public static void main(String[] args) throws Exception, Throwable
    {
        IBMPopulatingClient ibmclient = new IBMPopulatingClient();

        PerformanceTuningAdapter adapter = new PerformanceTuningAdapterComponent();

        ibmclient.populateProductStructure(adapter);

        ibmclient.populateVarLife(adapter);

        ibmclient.populateEIA(adapter);

        ibmclient.populateSPDA(adapter);
    }



    private String addClient(PerformanceTuningAdapter adapter, String clientId, String birthDate, String genderCT,
                             String firstName, String lastName) throws Throwable
    {
        ...
        clientAddressVO.setAddressTypeCT("PrimaryAddress");
        ...
        String clientDetailPK = adapter.addClient(clientDetailAsXML);
    ...
    private String  addClientRole(PerformanceTuningAdapter adapter, String clientId, String roleTypeCT) throws Throwable
    {
        ...
        String clientRolePK = adapter.addClientRole(clientIdentification, clientRoleAsXML);

        if (debug)
        {
            System.out.println("addClientRole");
...
//    }
    ...
    private SegmentVO addPolicyLife(PerformanceTuningAdapter adapter, String contractNumber, String effectiveDate,
                             ProductStructureVO productStructureVO, ArrayList clientRolePKs) throws Throwable
    {
//        String masterNumber = contractNumber;
        ...
        String productStructureAsXML = Util.marshalVO(productStructureVO);
        String[] induaseContractClientsAsXML = Util.marshalVOs(induaseContractClientVOs);

        String segmentPK = adapter.addPolicy(segmentAsXML, caseNumber,
                                 productStructureAsXML,
...
//    }
    ...
    private void processPremiumLife(PerformanceTuningAdapter adapter, SegmentVO segmentVO, int numberOfContracts) throws Throwable
    {
        ...
        String editTrxPK = adapter.addPremiumTrx(segmentVO.getContractNumber(), policyAmount, segmentVO.getEffectiveDate());

        if (debug)
        {
            System.out.println("addPremiumTrx");
...
//        {
    ...
    private void processEIATransactions(PerformanceTuningAdapter adapter, SegmentVO segmentVO, int numberOfContracts) throws Throwable
     {
         //Now setup and process the initial premium trx
         String contractNumber = segmentVO.getContractNumber();
         processInitialPremium(adapter, contractNumber, numberOfContracts, segmentVO.getEffectiveDate());
         ...
         if (contractNumber.startsWith("EIA08") && numberOfContracts <= 3000)
         {
             ...
             String editTrxPK = adapter.addPremiumTrx(contractNumber, policyAmount, "2005/08/01");
         }
         else if (contractNumber.startsWith("ESUR"))
         {
             String policyAmount = "5000";
             String editTrxPK = adapter.addSurrenderTrx(contractNumber, policyAmount, "2005/08/01");
         }
         else if (contractNumber.startsWith("ETRAN"))
         {
             String policyAmount = "5000";
             String editTrxPK = adapter.addTransferTrx(contractNumber, policyAmount, "2005/08/01");
         }
         else if (contractNumber.startsWith("EWD"))
         {
             String policyAmount = "5000";
             String editTrxPK = adapter.addWithdrawalTrx(contractNumber, policyAmount, "2005/08/01");
         }
         else if (contractNumber.startsWith("EDTH"))
         {
             String policyAmount = "5000";
             String editTrxPK = adapter.addDeathTrx(contractNumber, policyAmount, "2005/08/01");
         }

         if (debug)
         {
             System.out.println("endEIATrx");
         }

     }

    private void processSPDATransactions(PerformanceTuningAdapter adapter, SegmentVO segmentVO, int numberOfContracts) throws Throwable
     {
         //Now setup and process the initial premium trx
         String contractNumber = segmentVO.getContractNumber();
         ...
         if (contractNumber.startsWith("SSUR"))
         {
             String policyAmount = "5000";
             String editTrxPK = adapter.addSurrenderTrx(contractNumber, policyAmount, "2005/02/01");
         }
         else if (contractNumber.startsWith("STRAN"))
         {
             String policyAmount = "5000";
             String editTrxPK = adapter.addTransferTrx(contractNumber, policyAmount, "2005/02/01");
         }
         else if (contractNumber.startsWith("SWD"))
         {
             String policyAmount = "5000";
             String editTrxPK = adapter.addWithdrawalTrx(contractNumber, policyAmount, "2005/02/01");
         }
         else if (contractNumber.startsWith("SDTH"))
         {
             String policyAmount = "5000";
             String editTrxPK = adapter.addDeathTrx(contractNumber, policyAmount, "2005/02/01");
         }
    ...
    private void processInitialPremium(PerformanceTuningAdapter adapter, String contractNumber, int numberOfContracts, String effectiveDate) throws Throwable
    {
        String policyAmount = null;
        ...
        String editTrxPK = adapter.addPremiumTrx(contractNumber, policyAmount, effectiveDate);
    }
...
//                        System.out.println("contractClientVOs[i].getBillLapseVOCount() = " + contractClientVOs[i].getBillLapseVOCount());
//                    }
//                }
//            }
//            else
...
//    }
    ...
    private void populateVarLife(PerformanceTuningAdapter adapter) throws Throwable
    {
        String companyName = "SEG";
         ...
         ProductStructureVO productStructureVO = buildProductStructureVO(
        ...
        int startingContractNumber = 0;             // first contract number to process (actually, the number - 1)

        //  1st set
        createContracts(adapter, contractNumberRoot1, numberOfContracts1, effectiveDate1, clientFirstName1, clientLastNameRoot1,
                    clientId1, birthDate1, genderCT1, roleTypeCTs, productStructureVO, startingContractNumber);

        // 2nd set
        createContracts(adapter, contractNumberRoot2, numberOfContracts2, effectiveDate2, clientFirstName2, clientLastNameRoot2,
                    clientId2, birthDate2, genderCT2, roleTypeCTs, productStructureVO, startingContractNumber);
    }

    private void populateEIA(PerformanceTuningAdapter adapter)  throws Throwable
    {
        String companyName = "SEG";
        ...
        //  Set 3
        String effectiveDate3 = "2004/08/01";
        int numberOfContracts3 = 500;
        String contractNumberRoot3 = "ESUR";    // Surrender
        ...
        //  Set 4
        String effectiveDate4 = "2004/08/01";
        int numberOfContracts4 = 300;
        String contractNumberRoot4 = "ETRAN";    // Transfers
        ...
        //  Set 5
        String effectiveDate5 = "2004/08/01";
        int numberOfContracts5 = 200;
        String contractNumberRoot5 = "EWD";    // WD
        ...
        //  Set 6
        String effectiveDate6 = "2004/08/01";
        int numberOfContracts6 = 200;
        String contractNumberRoot6 = "EDTH";    // Death
        ...
        //  3rd set
        createContracts(adapter, contractNumberRoot3, numberOfContracts3, effectiveDate3, clientFirstName3, clientLastNameRoot3,
                    clientId3, birthDate3, genderCT3, roleTypeCTs, productStructureVO, startingContractNumber);

        // 4th set
        createContracts(adapter, contractNumberRoot4, numberOfContracts4, effectiveDate4, clientFirstName4, clientLastNameRoot4,
                    clientId4, birthDate4, genderCT4, roleTypeCTs, productStructureVO, startingContractNumber);

        // 5th set
        createContracts(adapter, contractNumberRoot5, numberOfContracts5, effectiveDate5, clientFirstName5, clientLastNameRoot5,
                    clientId5, birthDate5, genderCT5, roleTypeCTs, productStructureVO, startingContractNumber);

         // 6th set
        createContracts(adapter, contractNumberRoot6, numberOfContracts6, effectiveDate6, clientFirstName6, clientLastNameRoot6,
                    clientId6, birthDate6, genderCT6, roleTypeCTs, productStructureVO, startingContractNumber);
    }

    private void populateSPDA(PerformanceTuningAdapter adapter)  throws Throwable
    {
        String companyName = "SEG";
        String marketingPackageName = "*";
        String groupProductName = "*";
        ...
        //  Set 1
        String effectiveDate1 = "2004/02/01";
        int numberOfContracts1 = 10000;
        String contractNumberRoot1 = "SPDA02";
        String clientFirstName1 = "Jane";
        String clientLastNameRoot1 = "Franklin";
        String genderCT1 = "Female";
        String birthDate1 = "1955/04/15";
        String clientId1 = "111000001";

        //  Set 3
       String effectiveDate3 = "2004/02/01";
       int numberOfContracts3 = 50;
       String contractNumberRoot3 = "SSUR";    // Surrender
       String clientFirstName3 = "Greg";
       String clientLastNameRoot3 = "Jenkins";
       String genderCT3 = "Male";
       String birthDate3 = "1970/05/15";
       String clientId3 = "444000001";

        //  Set 4
       String effectiveDate4 = "2004/02/01";
       int numberOfContracts4 = 30;
       String contractNumberRoot4 = "STRAN";    // Transfers
       String clientFirstName4 = "Kate";
       String clientLastNameRoot4 = "Adams";
       String genderCT4 = "Female";
       String birthDate4 = "1972/06/01";
       String clientId4 = "999000001";

        //  Set 5
       String effectiveDate5 = "2004/02/01";
       int numberOfContracts5 = 20;
       String contractNumberRoot5 = "SWD";    // WD
       String clientFirstName5 = "Joe";
       String clientLastNameRoot5 = "Burk";
       String genderCT5 = "Male";
       String birthDate5 = "1975/07/01";
       String clientId5 = "123000001";

        //  Set 6
       String effectiveDate6 = "2004/02/01";
       int numberOfContracts6 = 20;
       String contractNumberRoot6 = "SDTH";    // Death
       String clientFirstName6 = "Lisa";
       String clientLastNameRoot6 = "Chapman";
       String genderCT6 = "Female";
       String birthDate6 = "1976/08/01";
       String clientId6 = "456000001";
       ...
       // 2nd set
//        createContracts(adapter, contractNumberRoot2, numberOfContracts2, effectiveDate2, clientFirstName2, clientLastNameRoot2,
//                    clientId2, birthDate2, genderCT2, roleTypeCTs, productStructureVO);
    ...
    private void createContracts(PerformanceTuningAdapter adapter, String contractNumberRoot, int numberOfContracts, String effectiveDate,
                                String clientFirstName, String clientLastNameRoot, String clientId, String birthDate,
                                String genderCT, ArrayList roleTypeCTs, ProductStructureVO productStructureVO, int startingContractNumber) throws Throwable
    {
        for (int i = startingContractNumber; i < numberOfContracts; i++)
        {
            String contractNumber = contractNumberRoot + (i+1);

            ArrayList clientRolePKs = new ArrayList();

            addClient(adapter, clientId, birthDate, genderCT, clientFirstName, (clientLastNameRoot + (i+1)));

            for (int j = 0; j < roleTypeCTs.size(); j++)
            {
                String clientRolePK = addClientRole(adapter, clientId, (String) roleTypeCTs.get(j));
            ...
            {
                segmentVO = addPolicyLife(adapter, contractNumber, effectiveDate, productStructureVO, clientRolePKs);
                processPremiumLife(adapter, segmentVO, numberOfContracts);
            }
            else if (contractNumberRoot.startsWith("EIA"))
            {
                segmentVO = addPolicyEIA(adapter, contractNumber, effectiveDate, productStructureVO, clientRolePKs);
                processEIATransactions(adapter, segmentVO, numberOfContracts);
            }
            else // SPDA
            {
                segmentVO = addPolicySPDA(adapter, contractNumber, effectiveDate, productStructureVO, clientRolePKs);
                processSPDATransactions(adapter, segmentVO, numberOfContracts);
            }
    ...
    private SegmentVO addPolicyEIA(PerformanceTuningAdapter adapter, String contractNumber, String effectiveDate, ProductStructureVO productStructureVO, ArrayList clientRolePKs)  throws Throwable
    {
//        String masterNumber = contractNumber;
        String caseNumber = " ";
    ...
    private SegmentVO addPolicySPDA(PerformanceTuningAdapter adapter, String contractNumber, String effectiveDate, ProductStructureVO productStructureVO, ArrayList clientRolePKs)  throws Throwable
    {
//        String masterNumber = contractNumber;
        String caseNumber = " ";
        ...
        //  Add Investments
        InvestmentVO investmentVO1 = buildInvestmentVO("1.0", "1068045685686");
    ...
    public ProductStructureVO populateProductStructure(PerformanceTuningAdapter adapter)  throws Throwable
    {
        String companyName = "SEG";
        String marketingPackageName = "Series7";
        String groupProductName = "*";
        ...
        String productStructurePK = adapter.addProductStructure(productStructureAsXML);

        if (debug)
        {
            System.out.println("addProductStructure");

            if (productStructurePK != null)
            {
                System.out.println("productStructurePK = " + productStructurePK);
            }
            else
            {
                System.out.println("No Results");
