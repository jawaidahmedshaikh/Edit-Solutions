...
import extension.business.PerformanceTuningAdapter;
...
/**
 * A specialized interface for the Induase product to access the EDITSolutions system via their own user interface.
 * <P>
 ...
 */
public class PerformanceTuningAdapterComponent extends AbstractComponent implements PerformanceTuningAdapter
{

    /**
     * @see  extension.business.PerformanceTuningAdapter#addClient
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#addClientRole
     */
    ...
    /**
     * @see extension.business.PerformanceTuningAdapter#addContractClientToExistingContractAndClientRole
     */
...
//        BillingVO billingVO = (BillingVO) billLapseVO.getParentVO(BillingVO.class);
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#addSuspense
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#addPolicy
     */
                            ...
                            String[] induaseContractClientsAsXML) throws Throwable
    {
        ...
        CompanyVO companyVO = (CompanyVO)productStructureVO.getParentVO(CompanyVO.class);
        ...
        //  Find the Master and set the Segment's FK
//        if ((masterNumber != null) && (! masterNumber.equals("")))
//        {
//            // They provided a masterNumber, go find the appropriate Master
//            contract.business.Lookup contractlookupComponent = new contract.component.LookupComponent();
//            MasterVO[] masterVOs = contractlookupComponent.findMasterByMasterNumber(masterNumber, false, null);
//
//            masterVO = masterVOs[0];
//
//            //  Associate the master to the segment
//            segmentVO.setMasterFK(masterVO.getMasterPK());
//        }
        ...
        ProductStructureVO[] existingProductStructureVOs = engineLookupComponent.findProductStructureByNames(
                companyVO.getCompanyName(), productStructureVO.getMarketingPackageName(),
        ...
        eventComponent.commitContract(segmentVO, "Seg", "N", null, "false");
    ...
    public String addProductStructure(String productStructureAsXML) throws Throwable
    {
        ...
        if (existingProductStructureVOs != null)
        {
            productStructurePK = existingProductStructureVOs[0].getProductStructurePK();
        }
        else
        {
            ProductStructure productStructure = new ProductStructure(productStructureVO);
            productStructure.save();
            productStructurePK = productStructure.getPK();

            engine.business.Calculator calcComponent = new engine.component.CalculatorComponent();
            long[] filteredFundFKs = new long[] {1083613932106L, 1082752948622L};
            calcComponent.attachFilteredFundToProduct(productStructurePK, filteredFundFKs);
        }


        return Long.toString(productStructurePK);
    }


    /**
     * @see  extension.business.PerformanceTuningAdapter#deleteClient
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#deleteSuspense
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#updateClient
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#updateSuspense
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#updatePolicy
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#saveGroupPolicyGroup
     */
//    public void saveGroupPolicyGroup(String policyGroupAsXML, String billingAsXML) throws Throwable
//    {
//        // Convert XML to VO
//        PolicyGroupVO policyGroupVO = (PolicyGroupVO) Util.unmarshalVO(PolicyGroupVO.class, policyGroupAsXML);
//        BillingVO billingVO = (BillingVO) Util.unmarshalVO(BillingVO.class, billingAsXML);
//
//        //  Set pk to zero for saving
//        policyGroupVO.setPolicyGroupPK(0);
//
//        //  Save
//        Contract contractComponent = new ContractComponent();
//
//        contractComponent.saveGroupPolicyGroup(policyGroup, billingVO);
//    }

    /**
     * @see  extension.business.PerformanceTuningAdapter#saveListMaster
     */
...
//    }
    ...
    /**
     * @see extension.business.PerformanceTuningAdapter#issueNewBusiness
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#processInforceQuote
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#processTransaction
     */
...
//        this.attachCorrespondence(editTrxVO);
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#deleteTransaction
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#updateTransaction
     */
...
//        this.attachCorrespondence(editTrxVO);
    ...
    /**
     * @see extension.business.PerformanceTuningAdapter#reverseHistory
     */
...
//                        riderSegments[i].removeAllChangeHistoryVO();
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#retrieveAllPendingTransactions
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#retrieveAllPendingTransactionsForContract
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#retrieveAllTransactionHistoryForContract
     */
    ...
    /**
     * @see extension.business.PerformanceTuningAdapter#retrieveAllChangeHistoryForContract
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#retrieveAllSuspense
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#retrieveAllPolicyGroupsOfGroupType
     */
//    public String[] retrieveAllPolicyGroupsOfGroupType(String groupTypeCT) throws Throwable
//    {
////        contract.business.Lookup lookupComponent = new contract.component.LookupComponent();
////
////        MasterVO[] masterVOs = lookupComponent.findMasterByGroupType(groupTypeCT);
//
//        PolicyGroupVO[] policyGroupVOs = PolicyGroup.findByGroupType(groupTypeCT);
//
//        return Util.marshalVOs(policyGroupVOs);
//    }

    /**
     * @see  extension.business.PerformanceTuningAdapter#retrievePolicy
     */
...
//    }
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#retrieveSuspenseByUserDefNumber
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#retrieveSuspenseByPK
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#getCodeTableDescription
     */
    ...
    /**
     * @see  extension.business.PerformanceTuningAdapter#getCodeTableEntries
     */
...
//                if (policyGroup != null)
//                {
//                    if (policyGroup.isTypeGroup())
//                    {
//                        //  For policyGroups of type Case, get the Billing from the database
//                        contract.business.Lookup contractlookupComponent = new contract.component.LookupComponent();
...
//            SegmentVO segmentVO = composeBaseSegmentVOByContractNumber(contractNumber);
            SegmentVO segmentVO = contract.dm.dao.DAOFactory.getSegmentDAO().findSegmentByContractNumber(contractNumber, false, null)[0];

            GroupSetupVO groupSetupVO = getGroupSetup(segmentVO, contractEvent);

            groupSetupVO.setPremiumTypeCT("Cash");
            groupSetupVO.getContractSetupVO(0).setPolicyAmount(new EDITBigDecimal(policyAmount, 2).getBigDecimal());

            int taxYear = new EDITDate(segmentVO.getEffectiveDate()).getYear();
            String operator = segmentVO.getCreationOperator();

            EDITTrxVO editTrxVO = contractEvent.buildDefaultEDITTrxVO("PY", new EDITDate(effectiveDate), taxYear, operator);

            event.business.Event eventComponent = new event.component.EventComponent();
            eventComponent.saveGroupSetup(groupSetupVO, editTrxVO, "PY", segmentVO.getOptionCodeCT(), segmentVO.getProductStructureFK());
//            editTrxPK = editTrxVO.getEDITTrxPK();
        ...
        return Long.toString(editTrxPK);
    }
...
//        SegmentVO segmentVO = composeBaseSegmentVOByContractNumber(contractNumber);
        ...
        EDITTrxVO editTrxVO = contractEvent.buildDefaultEDITTrxVO("FS", new EDITDate(effectiveDate), taxYear, operator);

        event.business.Event eventComponent = new event.component.EventComponent();
        eventComponent.saveGroupSetup(groupSetupVO, editTrxVO, "FS", segmentVO.getOptionCodeCT(), segmentVO.getProductStructureFK());
    ...
    public String addTransferTrx(String contractNumber, String policyAmount, String effectiveDate) throws Throwable
    {
        ...
        EDITDate edEffectiveDate = new EDITDate(effectiveDate);

        int taxYear = edEffectiveDate.getYear();
        String operator = "SYSTEM";

        EDITTrxVO editTrxVO = contractEvent.buildDefaultEDITTrxVO("TF", edEffectiveDate, taxYear, operator);
        ...
        long filteredFundFK = 1073582841764L;
        editTrx.createTransferTransactionGroupSetup(segment, segmentVO.getInvestmentVO(0), filteredFundFK, new EDITBigDecimal(policyAmount, 2).getBigDecimal());
...
//        SegmentVO segmentVO = composeBaseSegmentVOByContractNumber(contractNumber);
        ...
        EDITTrxVO editTrxVO = contractEvent.buildDefaultEDITTrxVO("WI", new EDITDate(effectiveDate), taxYear, operator);

        event.business.Event eventComponent = new event.component.EventComponent();
        eventComponent.saveGroupSetup(groupSetupVO, editTrxVO, "WI", segmentVO.getOptionCodeCT(), segmentVO.getProductStructureFK());
        long editTrxPK = editTrxVO.getEDITTrxPK();
...
//        SegmentVO segmentVO = composeBaseSegmentVOByContractNumber(contractNumber);
        ...
        GroupSetupVO groupSetupVO = getGroupSetup(segmentVO, contractEvent);
        groupSetupVO.getContractSetupVO(0).setDeathStatusCT("DeathLump");

        int taxYear = new EDITDate(segmentVO.getEffectiveDate()).getYear();
        String operator = segmentVO.getCreationOperator();

        EDITTrxVO editTrxVO = contractEvent.buildDefaultEDITTrxVO("DE", new EDITDate(effectiveDate), taxYear, operator);

        event.business.Event eventComponent = new event.component.EventComponent();
        eventComponent.saveGroupSetup(groupSetupVO, editTrxVO, "DE", segmentVO.getOptionCodeCT(), segmentVO.getProductStructureFK());
        long editTrxPK = editTrxVO.getEDITTrxPK();

        return null;
    }

    private GroupSetupVO getGroupSetup(SegmentVO segmentVO, ContractEvent contractEvent)
    {
        Segment segment = new Segment(segmentVO);
