...
public class Calltocalcfocus extends Inst
{
	private Map<String, Object> map = new HashMap<>();
    
    public Calltocalcfocus()
    {
    }
...
//			    map.put("EDITTrxVOs", editTrxVOs);
        	...
        	map.put("CFTrxRequestAmount", Util.initString((String) sp.getWSEntry("CFTrxRequestAmount"), "0"));
       ...
       /*     try {
        ...
        catch (Exception e)
        {
            ...
            throw new SPException("Failed CallToCalcFocus ", SPException.PARAMETER_INVALID_ERROR, e);
        }
        finally
        {
    ...
    public Element createPolicySummaryElement(PolicySummary pol) {
		...
		eventCycleConsequencesVO.setFaceAmount(new BigDecimal(ecc.getFaceAmount()));
        ...
        for (EventCycleConsequencesCoverage cov : pol.getEventCycleConsequencesCoverage()) {
    		...
    		Calendar calendar = cov.getEffectiveDate().toGregorianCalendar();
    		SimpleDateFormat formatter = new SimpleDateFormat("yyyy/MM/dd");
    		formatter.setTimeZone(calendar.getTimeZone());
    		String dateString = formatter.format(calendar.getTime());
    		coverageVO.setEffectiveDate(dateString);
    		...
    		coverageVO.setFaceAmount(new BigDecimal(cov.getFaceAmount()));
