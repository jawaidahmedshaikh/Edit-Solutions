...
/**
 * This is the implementation for the Ifgt instruction.
 * The Ifgt intsruction is a conditional call instruction which:
 ...
 * the first value pushed onto the stack is greater than the second.
 */
public final class Ifgt extends InstOneOperand {
     ...
     */
    public Ifgt() throws SPException  {
     ...
     */
   	protected void exec(ScriptProcessor execSP) throws SPException {
        ...
        if (operandsGT(operand1, operand2)) {
    ...
    private boolean operandsGT(String operandx, String operandy) throws SPException {
