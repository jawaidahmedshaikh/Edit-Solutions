...
/**
 * This is the implementation for the Ifne instruction.
 * The Ifne intsruction is a conditional call instruction which:
 ...
 * the first value pushed onto the stack is not equal the second.
 */
public final class Ifne extends InstOneOperand {
     ...
     */
    public Ifne() throws SPException  {
