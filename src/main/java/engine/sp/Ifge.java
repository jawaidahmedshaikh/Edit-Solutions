...
/**
 * This is the implementation for the Ifge instruction.
 * The Ifge intsruction is a conditional call instruction which:
 ...
 * the first value pushed onto the stack is greater/equal to the second.
 */
public final class Ifge extends InstOneOperand {
     ...
     */
    public Ifge() throws SPException  {
     ...
     */
   	protected void exec(ScriptProcessor execSP) throws SPException {
        ...
        if (operandsGE(operand1, operand2)) {
    ...
    private boolean operandsGE(String operandx, String operandy) throws SPException {
