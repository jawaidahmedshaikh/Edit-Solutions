...
/**
 * This is the implementation for the Call instruction.
 * The Call instruction will change the instruction pointer
 * to be changed to the first instruction of the subroutine
 * identified by the label found in the operand.
 */
public final class Call extends InstOneOperand {
     ...
     */
    public Call() throws SPException  {
