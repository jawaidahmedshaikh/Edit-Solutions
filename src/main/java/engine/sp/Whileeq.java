...
/**
 * This is the implementation for the "Whileeq" instruction.
 * The "Whileeq" instruction is used for the looping process
 ...
 * Whileeq
 */
public final class Whileeq extends Inst {
     ...
     */
   	protected void exec(ScriptProcessor execSP) throws SPException {
        ...
        if (operandsEqual(operand1, operand2)) {
    ...
    private boolean operandsEqual(String operandx, String operandy) throws SPException {
