...
/**
 * Instruction to create and persist a transaction. This instruction builds the GroupSetup, ContractSetup, and partial EDITTrx.
 ...
 */
public class Createandsavetransaction extends Inst
{
        ...
        if (billSchedulePKString != null)
        {
            ...
            if (groupContractGroup != null)
            {
                ...
                for (Iterator iterator = segments.iterator(); iterator.hasNext();)
                {
                    ...
                    {
                        createTransaction(segment, amount, trxType, effectiveDate, originatingTrxFK, suspenseFK, complexChangeTypeCT, nfChange, trxAmount, memoCode, noCommissionInd, zeroLoadInd);
                    }
                }
            }
            else
            {
                ...
                createTransaction(segment[0], amount, trxType, effectiveDate, originatingTrxFK, suspenseFK, complexChangeTypeCT, nfChange, trxAmount, memoCode, noCommissionInd, zeroLoadInd);
            }
        }
    ...
    private void createTransaction(Segment segment, EDITBigDecimal amount, String trxType, EDITDate effectiveDate,
                                   ...
                                   String memoCode, String noCommissionInd, String zeroLoadInd) throws SPException
    {
        ...
        EDITTrx editTrx = buildPartialEDITTrx(trxType, effectiveDate, amount, originatingTrxFK, nfChange, noCommissionInd, zeroLoadInd);
        ...
        if (participatingInNonFinancialFramework(nfChange)) {
	        ...
	        try {
	        	...
	        	throw new SPException("Createandsavetransaction: " + e.getMessage(), SPException.INSTRUCTION_PROCESSING_ERROR);
	        } finally {
	        	if (crud != null) {
                  crud.close();
	        	}
    ...
    private EDITTrx buildPartialEDITTrx(String transactionTypeCT, EDITDate effectiveDate, EDITBigDecimal amount, Long originatingTrxFK, 
    		String nfChange, String noCommissionInd, String zeroLoadInd)
    {
