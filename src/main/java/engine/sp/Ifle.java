...
/**
 * This is the implementation for the Ifle instruction.
 * The Ifle intsruction is a conditional call instruction which:
 ...
 * the first value pushed onto the stack is less/equal to the second.
 */
public final class Ifle extends InstOneOperand {
     ...
     */
    public Ifle() throws SPException  {
     ...
     */
   	protected void exec(ScriptProcessor execSP) throws SPException {
        ...
        if (operandsLE(operand1, operand2)) {
    ...
    private boolean operandsLE(String operandx, String operandy) throws SPException {
