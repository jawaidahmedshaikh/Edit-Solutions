...
/**
 * This is the implementation for the Ifeq instruction.
 * The Ifeq instruction is a conditional call instruction which:
 ...
 * the first value pushed onto the stack is equal to the second.
 */
public final class Ifeq extends InstOneOperand {
     ...
     */
    public Ifeq() throws SPException  {
     ...
     */
   	protected void exec(ScriptProcessor execSP) throws SPException {
        ...
        if (operandsEQ(operand1, operand2)) {
    ...
    private boolean operandsEQ(String operandx, String operandy) throws SPException {
