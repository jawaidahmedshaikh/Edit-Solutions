...
/**
 * This is the implementation of the Agenearest birthday instruction.
 * This will return the age on the closest birthday from the date 
 * given. The system will assume that the lesser date is the birthdate.
 * <p>
 * Sample script for Agenearestbirthday:
 * push date:1945/01/01
 * push date:1997/07/01
 * agenearestbirthday
 */
public final class Agenearestbirthday extends Inst {
...
//        String type = "near";
        ...
        //  Determine the greater date and calculate age
...
//            age = interimresult1.getAge(interimresult2, type);
            age = interimresult2.getAgeAtNearestBirthday(interimresult1);
	    }
        else
        {
//            age = interimresult2.getAge(interimresult1, type);
            age = interimresult1.getAgeAtNearestBirthday(interimresult2);
	    }
