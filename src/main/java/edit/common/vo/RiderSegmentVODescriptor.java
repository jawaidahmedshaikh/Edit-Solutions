...
/**
 * Class RiderSegmentVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class RiderSegmentVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public RiderSegmentVODescriptor() {
        super();
        xmlName = "RiderSegmentVO";
        ...
        //-- _riderSegmentPK
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(long.class, "_riderSegmentPK", "RiderSegmentPK", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                RiderSegmentVO target = (RiderSegmentVO) object;
                if(!target.hasRiderSegmentPK())
                    return null;
                return new Long(target.getRiderSegmentPK());
            }
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setRiderSegmentPK( ((Long)value).longValue());
                }
        ...
        //-- validation code for: _riderSegmentPK
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.RiderSegmentVODescriptor()
    ...
    {
        return edit.common.vo.RiderSegmentVO.class;
