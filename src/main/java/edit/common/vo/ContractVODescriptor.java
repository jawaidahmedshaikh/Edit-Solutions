...
/**
 * Class ContractVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ContractVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ContractVODescriptor() {
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ContractVO target = (ContractVO) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.ContractVODescriptor()
    ...
    {
        return edit.common.vo.ContractVO.class;
