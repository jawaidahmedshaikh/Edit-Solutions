...
/**
 * Class UISearchAgentVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class UISearchAgentVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public UISearchAgentVODescriptor() {
        super();
        xmlName = "UISearchAgentVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                UISearchAgentVO target = (UISearchAgentVO) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _agentNumberListList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(edit.common.vo.AgentNumberList.class, "_agentNumberListList", "AgentNumberList", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                UISearchAgentVO target = (UISearchAgentVO) object;
                return target.getAgentNumberList();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    UISearchAgentVO target = (UISearchAgentVO) object;
                    target.addAgentNumberList( (edit.common.vo.AgentNumberList) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new edit.common.vo.AgentNumberList();
            }
        } );
        desc.setHandler(handler);
        ...
        //-- validation code for: _agentNumberListList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(0);
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.UISearchAgentVODescriptor()
    ...
    {
        return edit.common.vo.UISearchAgentVO.class;
