...
/**
 * Class InvestmentTransferValueVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class InvestmentTransferValueVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public InvestmentTransferValueVODescriptor() {
        super();
        xmlName = "InvestmentTransferValueVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                InvestmentTransferValueVO target = (InvestmentTransferValueVO) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.InvestmentTransferValueVODescriptor()
    ...
    {
        return edit.common.vo.InvestmentTransferValueVO.class;
