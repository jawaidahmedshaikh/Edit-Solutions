...
/**
 * Class UISearchContractVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class UISearchContractVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public UISearchContractVODescriptor() {
        super();
        xmlName = "UISearchContractVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                UISearchContractVO target = (UISearchContractVO) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _relationship
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_relationship", "Relationship", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    UISearchContractVO target = (UISearchContractVO) object;
                    target.setRelationship( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _relationship
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
            StringValidator typeValidator = new StringValidator();
            typeValidator.setWhiteSpace("preserve");
        ...
        desc.setValidator(fieldValidator);
        //-- _option
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_option", "Option", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    UISearchContractVO target = (UISearchContractVO) object;
                    target.setOption( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.UISearchContractVODescriptor()
    ...
    {
        return edit.common.vo.UISearchContractVO.class;
