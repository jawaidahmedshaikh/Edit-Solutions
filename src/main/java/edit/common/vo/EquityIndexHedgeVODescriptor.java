...
/**
 * Class EquityIndexHedgeVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class EquityIndexHedgeVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public EquityIndexHedgeVODescriptor() {
        super();
        xmlName = "EquityIndexHedgeVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                EquityIndexHedgeVO target = (EquityIndexHedgeVO) object;
    ...
    } //-- edit.common.vo.EquityIndexHedgeVODescriptor()
    ...
    {
        return edit.common.vo.EquityIndexHedgeVO.class;
