...
/**
 * Class CheckNumberImportVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class CheckNumberImportVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CheckNumberImportVODescriptor() {
        super();
        xmlName = "CheckNumberImportVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CheckNumberImportVO target = (CheckNumberImportVO) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.CheckNumberImportVODescriptor()
    ...
    {
        return edit.common.vo.CheckNumberImportVO.class;
