...
/**
 * Class SeparateAccountValueDetailsVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SeparateAccountValueDetailsVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SeparateAccountValueDetailsVODescriptor() {
        super();
        xmlName = "SeparateAccountValueDetailsVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                SeparateAccountValueDetailsVO target = (SeparateAccountValueDetailsVO) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _investmentValue
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.math.BigDecimal.class, "_investmentValue", "InvestmentValue", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                SeparateAccountValueDetailsVO target = (SeparateAccountValueDetailsVO) object;
                return target.getInvestmentValue();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SeparateAccountValueDetailsVO target = (SeparateAccountValueDetailsVO) object;
                    target.setInvestmentValue( (java.math.BigDecimal) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _investmentValue
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            DecimalValidator typeValidator = new DecimalValidator();
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.SeparateAccountValueDetailsVODescriptor()
    ...
    {
        return edit.common.vo.SeparateAccountValueDetailsVO.class;
