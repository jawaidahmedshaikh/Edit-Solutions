...
/**
 * Class ClientAgentVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ClientAgentVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ClientAgentVODescriptor() {
        super();
        xmlName = "ClientAgentVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ClientAgentVO target = (ClientAgentVO) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.ClientAgentVODescriptor()
    ...
    {
        return edit.common.vo.ClientAgentVO.class;
