...
/**
 * Class ClientContractVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ClientContractVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ClientContractVODescriptor() {
        super();
        xmlName = "ClientContractVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ClientContractVO target = (ClientContractVO) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.ClientContractVODescriptor()
    ...
    {
        return edit.common.vo.ClientContractVO.class;
