...
/**
 * Class InSuspenseVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class InSuspenseVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public InSuspenseVODescriptor() {
        super();
        xmlName = "InSuspenseVO";
        ...
        //-- _inSuspensePK
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(long.class, "_inSuspensePK", "InSuspensePK", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                InSuspenseVO target = (InSuspenseVO) object;
                if(!target.hasInSuspensePK())
                    return null;
                return new Long(target.getInSuspensePK());
            }
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setInSuspensePK( ((Long)value).longValue());
                }
        ...
        //-- validation code for: _inSuspensePK
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.InSuspenseVODescriptor()
    ...
    {
        return edit.common.vo.InSuspenseVO.class;
