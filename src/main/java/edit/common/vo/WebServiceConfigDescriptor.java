...
/**
 * Class WebServiceConfigDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class WebServiceConfigDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public WebServiceConfigDescriptor() {
        super();
        xmlName = "WebServiceConfig";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                WebServiceConfig target = (WebServiceConfig) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.WebServiceConfigDescriptor()
    ...
    {
        return edit.common.vo.WebServiceConfig.class;
