...
/**
 * Class ReinsuranceCheckDocVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ReinsuranceCheckDocVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ReinsuranceCheckDocVODescriptor() {
        super();
        xmlName = "ReinsuranceCheckDocVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ReinsuranceCheckDocVO target = (ReinsuranceCheckDocVO) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.ReinsuranceCheckDocVODescriptor()
    ...
    {
        return edit.common.vo.ReinsuranceCheckDocVO.class;
