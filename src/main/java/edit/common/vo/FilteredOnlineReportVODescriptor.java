...
/**
 * Class FilteredOnlineReportVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class FilteredOnlineReportVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public FilteredOnlineReportVODescriptor() {
        super();
        xmlName = "FilteredOnlineReportVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                FilteredOnlineReportVO target = (FilteredOnlineReportVO) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _onlineReportFK
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(long.class, "_onlineReportFK", "OnlineReportFK", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                FilteredOnlineReportVO target = (FilteredOnlineReportVO) object;
                if(!target.hasOnlineReportFK())
                    return null;
                return new Long(target.getOnlineReportFK());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setOnlineReportFK( ((Long)value).longValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _onlineReportFK
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            LongValidator typeValidator = new LongValidator();
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.FilteredOnlineReportVODescriptor()
    ...
    {
        return edit.common.vo.FilteredOnlineReportVO.class;
