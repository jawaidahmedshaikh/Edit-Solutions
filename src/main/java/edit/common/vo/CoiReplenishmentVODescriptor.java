...
/**
 * Class CoiReplenishmentVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class CoiReplenishmentVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CoiReplenishmentVODescriptor() {
        super();
        xmlName = "CoiReplenishmentVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CoiReplenishmentVO target = (CoiReplenishmentVO) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _investmentTransferValueVOList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(edit.common.vo.InvestmentTransferValueVO.class, "_investmentTransferValueVOList", "InvestmentTransferValueVO", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                CoiReplenishmentVO target = (CoiReplenishmentVO) object;
                return target.getInvestmentTransferValueVO();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    CoiReplenishmentVO target = (CoiReplenishmentVO) object;
                    target.addInvestmentTransferValueVO( (edit.common.vo.InvestmentTransferValueVO) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new edit.common.vo.InvestmentTransferValueVO();
            }
        } );
        desc.setHandler(handler);
        desc.setMultivalued(true);
        ...
        //-- validation code for: _investmentTransferValueVOList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(0);
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.CoiReplenishmentVODescriptor()
    ...
    {
        return edit.common.vo.CoiReplenishmentVO.class;
