 ...
 */
public class BIZComponentMethodVO extends edit.common.vo.VOObject  
implements java.io.Serializable
{
    ...
    /**
     * Field _componentMethodVO
     */
    private edit.common.vo.ComponentMethodVO _componentMethodVO;
    ...
    public BIZComponentMethodVO() {
        super();
    } //-- edit.common.vo.BIZComponentMethodVO()
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof BIZComponentMethodVO) {
        
            BIZComponentMethodVO temp = (BIZComponentMethodVO)obj;
            ...
            if (this._securedMethodVO != null) {
                ...
                return false;
            if (this._componentMethodVO != null) {
                if (temp._componentMethodVO == null) return false;
                else if (!(this._componentMethodVO.equals(temp._componentMethodVO))) 
                    return false;
            }
            else if (temp._componentMethodVO != null)
                return false;
            return true;
        }
        return false;
    ...
    /**
     * Method getComponentMethodVOReturns the value of field
     * 'componentMethodVO'.
     * 
     * @return the value of field 'componentMethodVO'.
     */
    public edit.common.vo.ComponentMethodVO getComponentMethodVO()
    {
        return this._componentMethodVO;
    } //-- edit.common.vo.ComponentMethodVO getComponentMethods()
    ...
    /**
     * Method setComponentMethodVOSets the value of field
     * 'componentMethodVO'.
     * 
     * @param componentMethodVO the value of field
     * 'componentMethodVO'.
     */
    public void setComponentMethodVO(edit.common.vo.ComponentMethodVO componentMethodVO)
    {
        this._componentMethodVO = componentMethodVO;
    } //-- void setComponentMethodVO(edit.common.vo.ComponentMethodVO) 
     ...
     * @param reader
     */
    public static edit.common.vo.BIZComponentMethodVO unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (edit.common.vo.BIZComponentMethodVO) Unmarshaller.unmarshal(edit.common.vo.BIZComponentMethodVO.class, reader);
    } //-- edit.common.vo.BIZComponentMethodVO unmarshal(java.io.Reader) 
