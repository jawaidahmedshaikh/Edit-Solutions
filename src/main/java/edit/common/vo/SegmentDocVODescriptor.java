...
/**
 * Class SegmentDocVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SegmentDocVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SegmentDocVODescriptor() {
        super();
        xmlName = "SegmentDocVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                SegmentDocVO target = (SegmentDocVO) object;
    ...
    } //-- edit.common.vo.SegmentDocVODescriptor()
    ...
    {
        return edit.common.vo.SegmentDocVO.class;
