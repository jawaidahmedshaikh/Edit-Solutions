...
/**
 * Class BIZSecuredMethodVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class BIZSecuredMethodVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public BIZSecuredMethodVODescriptor() {
        super();
        xmlName = "BIZSecuredMethodVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                BIZSecuredMethodVO target = (BIZSecuredMethodVO) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.BIZSecuredMethodVODescriptor()
    ...
    {
        return edit.common.vo.BIZSecuredMethodVO.class;
