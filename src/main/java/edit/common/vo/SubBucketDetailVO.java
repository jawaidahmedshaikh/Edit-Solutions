...
/**
 * Class SubBucketDetailVO.
 * 
 * @version $Revision$ $Date$
 */
public class SubBucketDetailVO extends edit.common.vo.VOObject  
implements java.io.Serializable
{
    ...
    /**
     * Field _SBChangeInFundValue
     */
    private java.math.BigDecimal _SBChangeInFundValue;

    /**
     * Field _equityIndexHedgeDetailFK
     */
    private long _equityIndexHedgeDetailFK;

    /**
     * keeps track of state for field: _equityIndexHedgeDetailFK
     */
    private boolean _has_equityIndexHedgeDetailFK;
    ...
    public SubBucketDetailVO() {
        super();
    } //-- edit.common.vo.SubBucketDetailVO()
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof SubBucketDetailVO) {
        
            SubBucketDetailVO temp = (SubBucketDetailVO)obj;
            ...
            if (this._SBFundValue != null) {
                ...
                return false;
            if (this._SBChangeInFundValue != null) {
                if (temp._SBChangeInFundValue == null) return false;
                else if (!(this._SBChangeInFundValue.equals(temp._SBChangeInFundValue))) 
                    return false;
            }
            else if (temp._SBChangeInFundValue != null)
                return false;
            if (this._equityIndexHedgeDetailFK != temp._equityIndexHedgeDetailFK)
                return false;
            if (this._has_equityIndexHedgeDetailFK != temp._has_equityIndexHedgeDetailFK)
                return false;
            return true;
        }
        return false;
    ...
    /**
     * Method getEquityIndexHedgeDetailFKReturns the value of field
     * 'equityIndexHedgeDetailFK'.
     * 
     * @return the value of field 'equityIndexHedgeDetailFK'.
     */
    public long getEquityIndexHedgeDetailFK()
    {
        return this._equityIndexHedgeDetailFK;
    } //-- long getEquityIndexHedgeDetailFK() 
    ...
    /**
     * Method getSBChangeInFundValueReturns the value of field
     * 'SBChangeInFundValue'.
     * 
     * @return the value of field 'SBChangeInFundValue'.
     */
    public java.math.BigDecimal getSBChangeInFundValue()
    {
        return this._SBChangeInFundValue;
    } //-- java.math.BigDecimal getSBChangeInFundValue() 
    ...
    /**
     * Method hasEquityIndexHedgeDetailFK
     */
    public boolean hasEquityIndexHedgeDetailFK()
    {
        return this._has_equityIndexHedgeDetailFK;
    } //-- boolean hasEquityIndexHedgeDetailFK() 
    ...
    /**
     * Method setEquityIndexHedgeDetailFKSets the value of field
     * 'equityIndexHedgeDetailFK'.
     * 
     * @param equityIndexHedgeDetailFK the value of field
     * 'equityIndexHedgeDetailFK'.
     */
    public void setEquityIndexHedgeDetailFK(long equityIndexHedgeDetailFK)
    {
        this._equityIndexHedgeDetailFK = equityIndexHedgeDetailFK;
        
        super.setVoChanged(true);
        this._has_equityIndexHedgeDetailFK = true;
    } //-- void setEquityIndexHedgeDetailFK(long) 
    ...
    /**
     * Method setSBChangeInFundValueSets the value of field
     * 'SBChangeInFundValue'.
     * 
     * @param SBChangeInFundValue the value of field
     * 'SBChangeInFundValue'.
     */
    public void setSBChangeInFundValue(java.math.BigDecimal SBChangeInFundValue)
    {
        this._SBChangeInFundValue = SBChangeInFundValue;
        
        super.setVoChanged(true);
    } //-- void setSBChangeInFundValue(java.math.BigDecimal) 
     ...
     * @param reader
     */
    public static edit.common.vo.SubBucketDetailVO unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (edit.common.vo.SubBucketDetailVO) Unmarshaller.unmarshal(edit.common.vo.SubBucketDetailVO.class, reader);
    } //-- edit.common.vo.SubBucketDetailVO unmarshal(java.io.Reader) 
