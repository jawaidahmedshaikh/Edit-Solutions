...
/**
 * Class ReinsuranceVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ReinsuranceVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ReinsuranceVODescriptor() {
        super();
        xmlName = "ReinsuranceVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ReinsuranceVO target = (ReinsuranceVO) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.ReinsuranceVODescriptor()
    ...
    {
        return edit.common.vo.ReinsuranceVO.class;
