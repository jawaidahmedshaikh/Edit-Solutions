...
/**
 * Class HierarchyReportVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class HierarchyReportVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public HierarchyReportVODescriptor() {
        super();
        xmlName = "HierarchyReportVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                HierarchyReportVO target = (HierarchyReportVO) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.HierarchyReportVODescriptor()
    ...
    {
        return edit.common.vo.HierarchyReportVO.class;
