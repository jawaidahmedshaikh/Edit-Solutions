...
/**
 * Class UIInvestmentOverrideVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class UIInvestmentOverrideVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public UIInvestmentOverrideVODescriptor() {
        super();
        xmlName = "UIInvestmentOverrideVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                UIInvestmentOverrideVO target = (UIInvestmentOverrideVO) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.UIInvestmentOverrideVODescriptor()
    ...
    {
        return edit.common.vo.UIInvestmentOverrideVO.class;
