...
/**
 * Class IssueClientVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class IssueClientVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public IssueClientVODescriptor() {
        super();
        xmlName = "IssueClientVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                IssueClientVO target = (IssueClientVO) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _clientPK
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(long.class, "_clientPK", "ClientPK", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                IssueClientVO target = (IssueClientVO) object;
                if(!target.hasClientPK())
                    return null;
                return new Long(target.getClientPK());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setClientPK( ((Long)value).longValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
        //-- _agentAllocation
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.math.BigDecimal.class, "_agentAllocation", "AgentAllocation", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                IssueClientVO target = (IssueClientVO) object;
                return target.getAgentAllocation();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    IssueClientVO target = (IssueClientVO) object;
                    target.setAgentAllocation( (java.math.BigDecimal) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _agentAllocation
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.IssueClientVODescriptor()
    ...
    {
        return edit.common.vo.IssueClientVO.class;
