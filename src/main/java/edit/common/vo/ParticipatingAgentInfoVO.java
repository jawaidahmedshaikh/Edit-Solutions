...
/**
 * Class ParticipatingAgentInfoVO.
 * 
 * @version $Revision$ $Date$
 */
public class ParticipatingAgentInfoVO extends edit.common.vo.VOObject  
implements java.io.Serializable
{
    ...
    /**
     * Field _bonusCheckAmount
     */
    private java.math.BigDecimal _bonusCheckAmount;

    /**
     * Field _bounsName
     */
    private java.lang.String _bounsName;

    /**
     * Field _premiumLevelStatementVOList
     */
    private java.util.Vector _premiumLevelStatementVOList;
    ...
    public ParticipatingAgentInfoVO() {
        super();
        _premiumLevelStatementVOList = new Vector();
    } //-- edit.common.vo.ParticipatingAgentInfoVO()
    ...
    /**
     * Method addPremiumLevelStatementVO
     * 
     * @param vPremiumLevelStatementVO
     */
    public void addPremiumLevelStatementVO(edit.common.vo.PremiumLevelStatementVO vPremiumLevelStatementVO)
        throws java.lang.IndexOutOfBoundsException
    {
        vPremiumLevelStatementVO.setParentVO(this.getClass(), this);
        _premiumLevelStatementVOList.addElement(vPremiumLevelStatementVO);
    } //-- void addPremiumLevelStatementVO(edit.common.vo.PremiumLevelStatementVO) 
     ...
     * @param vPremiumLevelStatementVO
     */
    public void addPremiumLevelStatementVO(int index, edit.common.vo.PremiumLevelStatementVO vPremiumLevelStatementVO)
        throws java.lang.IndexOutOfBoundsException
    {
        vPremiumLevelStatementVO.setParentVO(this.getClass(), this);
        _premiumLevelStatementVOList.insertElementAt(vPremiumLevelStatementVO, index);
    } //-- void addPremiumLevelStatementVO(int, edit.common.vo.PremiumLevelStatementVO) 

    /**
     * Method enumeratePremiumLevelStatementVO
     */
    public java.util.Enumeration enumeratePremiumLevelStatementVO()
    {
        return _premiumLevelStatementVOList.elements();
    } //-- java.util.Enumeration enumeratePremiumLevelStatementVO() 
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof ParticipatingAgentInfoVO) {
        
            ParticipatingAgentInfoVO temp = (ParticipatingAgentInfoVO)obj;
            ...
            if (this._redirectZip != null) {
                ...
                return false;
            if (this._bonusCheckAmount != null) {
                if (temp._bonusCheckAmount == null) return false;
                else if (!(this._bonusCheckAmount.equals(temp._bonusCheckAmount))) 
                    return false;
            }
            else if (temp._bonusCheckAmount != null)
                return false;
            if (this._bounsName != null) {
                if (temp._bounsName == null) return false;
                else if (!(this._bounsName.equals(temp._bounsName))) 
                    return false;
            }
            else if (temp._bounsName != null)
                return false;
            if (this._premiumLevelStatementVOList != null) {
                if (temp._premiumLevelStatementVOList == null) return false;
                else if (!(this._premiumLevelStatementVOList.equals(temp._premiumLevelStatementVOList))) 
                    return false;
            }
            else if (temp._premiumLevelStatementVOList != null)
                return false;
            return true;
        }
        return false;
    ...
    /**
     * Method getBonusCheckAmountReturns the value of field
     * 'bonusCheckAmount'.
     * 
     * @return the value of field 'bonusCheckAmount'.
     */
    public java.math.BigDecimal getBonusCheckAmount()
    {
        return this._bonusCheckAmount;
    } //-- java.math.BigDecimal getBonusCheckAmount() 

    /**
     * Method getBounsNameReturns the value of field 'bounsName'.
     * 
     * @return the value of field 'bounsName'.
     */
    public java.lang.String getBounsName()
    {
        return this._bounsName;
    } //-- java.lang.String getBounsName() 
    ...
    /**
     * Method getPremiumLevelStatementVO
     * 
     * @param index
     */
    public edit.common.vo.PremiumLevelStatementVO getPremiumLevelStatementVO(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _premiumLevelStatementVOList.size())) {
            throw new IndexOutOfBoundsException();
        }
        
        return (edit.common.vo.PremiumLevelStatementVO) _premiumLevelStatementVOList.elementAt(index);
    } //-- edit.common.vo.PremiumLevelStatementVO getPremiumLevelStatementVO(int) 

    /**
     * Method getPremiumLevelStatementVO
     */
    public edit.common.vo.PremiumLevelStatementVO[] getPremiumLevelStatementVO()
    {
        int size = _premiumLevelStatementVOList.size();
        edit.common.vo.PremiumLevelStatementVO[] mArray = new edit.common.vo.PremiumLevelStatementVO[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (edit.common.vo.PremiumLevelStatementVO) _premiumLevelStatementVOList.elementAt(index);
        }
        return mArray;
    } //-- edit.common.vo.PremiumLevelStatementVO[] getPremiumLevelStatementVO() 

    /**
     * Method getPremiumLevelStatementVOCount
     */
    public int getPremiumLevelStatementVOCount()
    {
        return _premiumLevelStatementVOList.size();
    } //-- int getPremiumLevelStatementVOCount() 
    ...
    /**
     * Method removeAllPremiumLevelStatementVO
     */
    public void removeAllPremiumLevelStatementVO()
    {
        _premiumLevelStatementVOList.removeAllElements();
    } //-- void removeAllPremiumLevelStatementVO() 

    /**
     * Method removePremiumLevelStatementVO
     * 
     * @param index
     */
    public edit.common.vo.PremiumLevelStatementVO removePremiumLevelStatementVO(int index)
    {
        java.lang.Object obj = _premiumLevelStatementVOList.elementAt(index);
        _premiumLevelStatementVOList.removeElementAt(index);
        return (edit.common.vo.PremiumLevelStatementVO) obj;
    } //-- edit.common.vo.PremiumLevelStatementVO removePremiumLevelStatementVO(int) 
    ...
    /**
     * Method setBonusCheckAmountSets the value of field
     * 'bonusCheckAmount'.
     * 
     * @param bonusCheckAmount the value of field 'bonusCheckAmount'
     */
    public void setBonusCheckAmount(java.math.BigDecimal bonusCheckAmount)
    {
        this._bonusCheckAmount = bonusCheckAmount;
        
        super.setVoChanged(true);
    } //-- void setBonusCheckAmount(java.math.BigDecimal) 

    /**
     * Method setBounsNameSets the value of field 'bounsName'.
     * 
     * @param bounsName the value of field 'bounsName'.
     */
    public void setBounsName(java.lang.String bounsName)
    {
        this._bounsName = bounsName;
        
        super.setVoChanged(true);
    } //-- void setBounsName(java.lang.String) 
    ...
    /**
     * Method setPremiumLevelStatementVO
     * 
     * @param index
     * @param vPremiumLevelStatementVO
     */
    public void setPremiumLevelStatementVO(int index, edit.common.vo.PremiumLevelStatementVO vPremiumLevelStatementVO)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _premiumLevelStatementVOList.size())) {
        ...
        vPremiumLevelStatementVO.setParentVO(this.getClass(), this);
        _premiumLevelStatementVOList.setElementAt(vPremiumLevelStatementVO, index);
    } //-- void setPremiumLevelStatementVO(int, edit.common.vo.PremiumLevelStatementVO) 

    /**
     * Method setPremiumLevelStatementVO
     * 
     * @param premiumLevelStatementVOArray
     */
    public void setPremiumLevelStatementVO(edit.common.vo.PremiumLevelStatementVO[] premiumLevelStatementVOArray)
    {
        //-- copy array
        _premiumLevelStatementVOList.removeAllElements();
        for (int i = 0; i < premiumLevelStatementVOArray.length; i++) {
            premiumLevelStatementVOArray[i].setParentVO(this.getClass(), this);
            _premiumLevelStatementVOList.addElement(premiumLevelStatementVOArray[i]);
        }
    } //-- void setPremiumLevelStatementVO(edit.common.vo.PremiumLevelStatementVO) 
     ...
     * @param reader
     */
    public static edit.common.vo.ParticipatingAgentInfoVO unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (edit.common.vo.ParticipatingAgentInfoVO) Unmarshaller.unmarshal(edit.common.vo.ParticipatingAgentInfoVO.class, reader);
    } //-- edit.common.vo.ParticipatingAgentInfoVO unmarshal(java.io.Reader) 
