...
/**
 * Class CheckEFTDetailVODescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class CheckEFTDetailVODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CheckEFTDetailVODescriptor() {
        super();
        xmlName = "CheckEFTDetailVO";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CheckEFTDetailVO target = (CheckEFTDetailVO) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- edit.common.vo.CheckEFTDetailVODescriptor()
    ...
    {
        return edit.common.vo.CheckEFTDetailVO.class;
