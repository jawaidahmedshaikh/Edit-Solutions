 ...
 * ProductStructures.
 */
public class CandidateOtherUnderwritingTableModel extends TableModel
{
    ...
    public CandidateOtherUnderwritingTableModel(AppReqBlock appReqBlock, String filteredProductPK)
    {
        super(appReqBlock);
