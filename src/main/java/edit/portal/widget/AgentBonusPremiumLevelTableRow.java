 ...
 */
public class AgentBonusPremiumLevelTableRow extends TableRow
{
    ...
    public AgentBonusPremiumLevelTableRow(PremiumLevel premiumLevel)
    {
    ...
    private void mapColumnValues()
    {
        ...
        columnValues.put(AgentBonusPremiumLevelTableModel.COLUMN_PREMIUM_LEVEL, cellValueForIssPremLvl);
        columnValues.put(AgentBonusPremiumLevelTableModel.COLUMN_PROD_LEVEL_INCR_PCT, prodLevelIncrPct);
        columnValues.put(AgentBonusPremiumLevelTableModel.COLUMN_PROD_LEVEL_INCR_AMT, cellValueForProdLvlIncrAmt);
        columnValues.put(AgentBonusPremiumLevelTableModel.COLUMN_INCR_STOP_AMT, cellValueForincrStopAmt);
    }
