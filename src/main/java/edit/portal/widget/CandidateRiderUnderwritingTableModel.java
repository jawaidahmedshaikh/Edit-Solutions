 ...
 * ProductStructures.
 */
public class CandidateRiderUnderwritingTableModel extends TableModel
{
    ...
    public CandidateRiderUnderwritingTableModel(AppReqBlock appReqBlock, String filteredProductPK)
    {
        super(appReqBlock);
